...
This also closes active replications, listenres, and-or live queries connected to the database.  Closing a database soon after starting a replication involving it can cause an exeption as the asynchronous replicator my not yet be connected.
