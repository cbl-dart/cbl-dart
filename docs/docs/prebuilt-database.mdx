...
:::caution
Always start with a fresh database for each app version; this ensures there are no [**checkpoint**](https://docs.couchbase.com/couchbase-lite/current/swift/refer-glossary.html#checkpoint) issues. <br /><br />
