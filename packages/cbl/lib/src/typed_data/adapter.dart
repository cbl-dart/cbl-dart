...
abstract class TypedDataAdapter {
  ...
  /// Returns a factory for creating typed representations of [Dictionary]s
  /// with type [D].
  Factory<Dictionary, D>
      dictionaryFactoryForType<D extends TypedDictionaryObject>();

  /// Returns a factory for creating typed representations of [Document]s
  /// with type [D].
  Factory<Document, D> documentFactoryForType<D extends TypedDocumentObject>();

  /// Returns a factory for creating typed representations of [Document]s,
  /// which determines the typed document to instantiate based on its
  /// properties.
  ///
