...
abstract interface class GroupByRouter {
...
///
/// {@category Query Builder}
abstract interface class SyncGroupByRouter implements GroupByRouter {
  @override
  SyncGroupBy groupBy(
    ExpressionInterface expression0, [
    ExpressionInterface? expression1,
...
///
/// {@category Query Builder}
abstract interface class AsyncGroupByRouter implements GroupByRouter {
  @override
