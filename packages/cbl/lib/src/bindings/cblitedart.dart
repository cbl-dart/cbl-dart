...
class cblitedart {
  ...
  void CBLDart_FLSliceResult_RetainByBuf(ffi.Pointer<ffi.Void> buf) {
    return _CBLDart_FLSliceResult_RetainByBuf(buf);
  }
  ...
  void CBLDart_FLSliceResult_ReleaseByBuf(ffi.Pointer<ffi.Void> buf) {
    return _CBLDart_FLSliceResult_ReleaseByBuf(buf);
  }
  ...
  late final _CBLDart_KnownSharedKeys_New =
      _CBLDart_KnownSharedKeys_NewPtr.asFunction<
        DartCBLDart_KnownSharedKeys_New
      >();

  void CBLDart_KnownSharedKeys_Delete(ffi.Pointer<KnownSharedKeys> keys) {
    return _CBLDart_KnownSharedKeys_Delete(keys);
  }
  ...
  void CBLDart_GetLoadedFLValue(
    ...
    return _CBLDart_GetLoadedFLValue(value, out);
  }
  ...
  void CBLDart_FLArray_GetLoadedFLValue(
    ...
    return _CBLDart_FLArray_GetLoadedFLValue(array, index, out);
  }
  ...
  void CBLDart_FLDict_GetLoadedFLValue(
    ...
    return _CBLDart_FLDict_GetLoadedFLValue(dict, key, out);
  }
  ...
  late final _CBLDart_FLDictIterator_Begin =
      _CBLDart_FLDictIterator_BeginPtr.asFunction<
        DartCBLDart_FLDictIterator_Begin
      >();

  void CBLDart_FLDictIterator_Delete(
    ffi.Pointer<CBLDart_FLDictIterator> iterator,
  ) {
    return _CBLDart_FLDictIterator_Delete(iterator);
  }
  ...
  late final _CBLDart_FLDictIterator_Delete =
      _CBLDart_FLDictIterator_DeletePtr.asFunction<
        DartCBLDart_FLDictIterator_Delete
      >();

  bool CBLDart_FLDictIterator_Next(
    ffi.Pointer<CBLDart_FLDictIterator> iterator,
  ) {
    return _CBLDart_FLDictIterator_Next(iterator);
  }
  ...
  late final _CBLDart_FLDictIterator_Next =
      _CBLDart_FLDictIterator_NextPtr.asFunction<
        DartCBLDart_FLDictIterator_Next
      >();
  ...
  ffi.Pointer<CBLDart_FLArrayIterator> CBLDart_FLArrayIterator_Begin(
    ...
    return _CBLDart_FLArrayIterator_Begin(array, valueOut, deleteOnDone);
  }
  ...
  late final _CBLDart_FLArrayIterator_Begin =
      _CBLDart_FLArrayIterator_BeginPtr.asFunction<
        DartCBLDart_FLArrayIterator_Begin
      >();

  void CBLDart_FLArrayIterator_Delete(
    ffi.Pointer<CBLDart_FLArrayIterator> iterator,
  ) {
    return _CBLDart_FLArrayIterator_Delete(iterator);
  }
  ...
  bool CBLDart_FLArrayIterator_Next(
    ...
    return _CBLDart_FLArrayIterator_Next(iterator);
  }
  ...
  late final _CBLDart_FLArrayIterator_Next =
      _CBLDart_FLArrayIterator_NextPtr.asFunction<
        DartCBLDart_FLArrayIterator_Next
      >();
  ...
  bool CBLDart_FLEncoder_WriteArrayValue(
    ...
    return _CBLDart_FLEncoder_WriteArrayValue(encoder, array, index);
  }
  ...
  int CBLDart_Initialize(
    ...
    return _CBLDart_Initialize(dartInitializeDlData, cblInitContext, errorOut);
  }
  ...
  CBLDart_AsyncCallback CBLDart_AsyncCallback_New(
    ...
    return _CBLDart_AsyncCallback_New(id, sendPort, debug);
  }
  ...
  void CBLDart_AsyncCallback_Delete(CBLDart_AsyncCallback callback) {
    return _CBLDart_AsyncCallback_Delete(callback);
  }
  ...
  late final _CBLDart_AsyncCallback_Delete =
      _CBLDart_AsyncCallback_DeletePtr.asFunction<
        DartCBLDart_AsyncCallback_Delete
      >();

  void CBLDart_AsyncCallback_Close(CBLDart_AsyncCallback callback) {
    return _CBLDart_AsyncCallback_Close(callback);
  }
  ...
  late final _CBLDart_AsyncCallback_Close =
      _CBLDart_AsyncCallback_ClosePtr.asFunction<
        DartCBLDart_AsyncCallback_Close
      >();
  ...
  void CBLDart_AsyncCallback_CallForTest(
    ...
    return _CBLDart_AsyncCallback_CallForTest(callback, argument);
  }
  ...
  void CBLDart_Completer_Complete(CBLDart_Completer completer, int result) {
    return _CBLDart_Completer_Complete(completer, result);
  }
  ...
  late final _CBLDart_Completer_Complete =
      _CBLDart_Completer_CompletePtr.asFunction<
        DartCBLDart_Completer_Complete
      >();
  ...
  void CBLDart_SetCurrentIsolateId(int isolateId) {
    return _CBLDart_SetCurrentIsolateId(isolateId);
  }
  ...
  late final _CBLDart_SetCurrentIsolateId =
      _CBLDart_SetCurrentIsolateIdPtr.asFunction<
        DartCBLDart_SetCurrentIsolateId
      >();
  ...
  late final _CBLDart_GetCurrentIsolateId =
      _CBLDart_GetCurrentIsolateIdPtr.asFunction<
        DartCBLDart_GetCurrentIsolateId
      >();

  bool CBLDart_CBLLog_SetCallback(CBLDart_AsyncCallback callback) {
    return _CBLDart_CBLLog_SetCallback(callback);
  }
  ...
  late final _CBLDart_CBLLog_SetCallback =
      _CBLDart_CBLLog_SetCallbackPtr.asFunction<
        DartCBLDart_CBLLog_SetCallback
      >();

  void CBLDart_CBLLog_SetCallbackLevel(imp$1.DartCBLLogLevel level) {
    return _CBLDart_CBLLog_SetCallbackLevel(level);
  }
  ...
  bool CBLDart_CBLLog_SetSentryBreadcrumbs(bool enabled) {
    return _CBLDart_CBLLog_SetSentryBreadcrumbs(enabled);
  }
  ...
  late final _CBLDart_CBLDatabaseConfiguration_DefaultPtr =
      _lookup<
  ...
  bool CBLDart_CBL_CopyDatabase(
    ...
    return _CBLDart_CBL_CopyDatabase(fromPath, toName, config, outError);
  }
  ...
  ffi.Pointer<CBLDatabase> CBLDart_CBLDatabase_Open(
    ...
    return _CBLDart_CBLDatabase_Open(name, config, errorOut);
  }
  ...
  void CBLDart_CBLDatabase_Release(ffi.Pointer<CBLDatabase> database) {
    return _CBLDart_CBLDatabase_Release(database);
  }
  ...
  late final _CBLDart_CBLDatabase_Release =
      _CBLDart_CBLDatabase_ReleasePtr.asFunction<
        DartCBLDart_CBLDatabase_Release
      >();
  ...
  bool CBLDart_CBLDatabase_Close(
    ...
    return _CBLDart_CBLDatabase_Close(database, andDelete, errorOut);
  }
  ...
  late final _CBLDart_CBLCollection_AddDocumentChangeListenerPtr =
      _lookup<
        ffi.NativeFunction<
  ...
  void CBLDart_CBLCollection_AddChangeListener(
    ...
    return _CBLDart_CBLCollection_AddChangeListener(db, collection, listener);
  }

  late final _CBLDart_CBLCollection_AddChangeListenerPtr =
      _lookup<
  ...
  ffi.Pointer<CBLListenerToken> CBLDart_CBLQuery_AddChangeListener(
    ...
    return _CBLDart_CBLQuery_AddChangeListener(db, query, listener);
  }
  ...
  late final _CBLDart_PredictiveModel_New =
      _CBLDart_PredictiveModel_NewPtr.asFunction<
        DartCBLDart_PredictiveModel_New
      >();

  void CBLDart_PredictiveModel_Delete(CBLDart_PredictiveModel model) {
    return _CBLDart_PredictiveModel_Delete(model);
  }
  ...
  FLSliceResult CBLDart_CBLBlobReader_Read(
    ...
    return _CBLDart_CBLBlobReader_Read(stream, bufferSize, outError);
  }
  ...
  late final _CBLDart_CBLBlobReader_Read =
      _CBLDart_CBLBlobReader_ReadPtr.asFunction<
        DartCBLDart_CBLBlobReader_Read
      >();
  ...
  ffi.Pointer<CBLReplicator> CBLDart_CBLReplicator_Create(
    ...
    return _CBLDart_CBLReplicator_Create(config, errorOut);
  }
  ...
  late final _CBLDart_CBLReplicator_Create =
      _CBLDart_CBLReplicator_CreatePtr.asFunction<
        DartCBLDart_CBLReplicator_Create
      >();

  void CBLDart_CBLReplicator_Release(ffi.Pointer<CBLReplicator> replicator) {
    return _CBLDart_CBLReplicator_Release(replicator);
  }
  ...
  late final _CBLDart_CBLReplicator_Release =
      _CBLDart_CBLReplicator_ReleasePtr.asFunction<
        DartCBLDart_CBLReplicator_Release
      >();
  ...
  void CBLDart_CBLReplicator_AddChangeListener(
    ...
    return _CBLDart_CBLReplicator_AddChangeListener(db, replicator, listenerId);
  }

  late final _CBLDart_CBLReplicator_AddChangeListenerPtr =
      _lookup<
  ...
  late final _CBLDart_CBLReplicator_AddDocumentReplicationListenerPtr =
      _lookup<
        ffi.NativeFunction<
  ...
  bool CBLDart_ListenerPasswordAuthCallbackTrampoline(
    ...
    return _CBLDart_ListenerPasswordAuthCallbackTrampoline(
      context,
      username,
      password,
    );
  ...
  late final _CBLDart_ListenerPasswordAuthCallbackTrampolinePtr =
      _lookup<
        ffi.NativeFunction<NativeCBLDart_ListenerPasswordAuthCallbackTrampoline>
      >('CBLDart_ListenerPasswordAuthCallbackTrampoline');
  late final _CBLDart_ListenerPasswordAuthCallbackTrampoline =
      _CBLDart_ListenerPasswordAuthCallbackTrampolinePtr.asFunction<
        DartCBLDart_ListenerPasswordAuthCallbackTrampoline
      >();
  ...
  bool CBLDart_ListenerCertAuthCallbackTrampoline(
    ...
    return _CBLDart_ListenerCertAuthCallbackTrampoline(context, cert);
  }

  late final _CBLDart_ListenerCertAuthCallbackTrampolinePtr =
      _lookup<
        ffi.NativeFunction<NativeCBLDart_ListenerCertAuthCallbackTrampoline>
      >('CBLDart_ListenerCertAuthCallbackTrampoline');
  late final _CBLDart_ListenerCertAuthCallbackTrampoline =
      _CBLDart_ListenerCertAuthCallbackTrampolinePtr.asFunction<
        DartCBLDart_ListenerCertAuthCallbackTrampoline
      >();
...
class SymbolAddresses {
  ...
  get CBLDart_AsyncCallback_Delete => _library._CBLDart_AsyncCallback_DeletePtr;
  ffi.Pointer<ffi.NativeFunction<NativeCBLDart_CBLDatabase_Release>>
  get CBLDart_CBLDatabase_Release => _library._CBLDart_CBLDatabase_ReleasePtr;
  ...
  get CBLDart_ListenerPasswordAuthCallbackTrampoline =>
      _library._CBLDart_ListenerPasswordAuthCallbackTrampolinePtr;
  ffi.Pointer<
    ffi.NativeFunction<NativeCBLDart_ListenerCertAuthCallbackTrampoline>
  >
  get CBLDart_ListenerCertAuthCallbackTrampoline =>
      _library._CBLDart_ListenerCertAuthCallbackTrampolinePtr;
}
