...
class cblitedart {
  ...
  late final _CBLDart_ListenerPasswordAuthCallbackTrampolinePtr = _lookup<
          ffi.NativeFunction<
              NativeCBLDart_ListenerPasswordAuthCallbackTrampoline>>(
  ...
  bool CBLDart_ListenerCertAuthCallbackTrampoline(
    ...
    return _CBLDart_ListenerCertAuthCallbackTrampoline(
      context,
      cert,
    );
  }

  late final _CBLDart_ListenerCertAuthCallbackTrampolinePtr = _lookup<
...
typedef NativeCBLDart_GetLoadedFLValue = ffi.Void Function(
    imp$1.FLValue value, ffi.Pointer<CBLDart_LoadedFLValue> out);
...
typedef DartCBLDart_FLArray_GetLoadedFLValue = void Function(
    imp$1.FLArray array, int index, ffi.Pointer<CBLDart_LoadedFLValue> out);
typedef NativeCBLDart_FLDict_GetLoadedFLValue = ffi.Void Function(
    imp$1.FLDict dict,
    imp$1.FLString key,
    ffi.Pointer<CBLDart_LoadedFLValue> out);
typedef DartCBLDart_FLDict_GetLoadedFLValue = void Function(imp$1.FLDict dict,
    imp$1.FLString key, ffi.Pointer<CBLDart_LoadedFLValue> out);
...
typedef NativeCBLDart_FLArrayIterator_Begin
    = ffi.Pointer<CBLDart_FLArrayIterator> Function(imp$1.FLArray array,
...
typedef NativeCBLDart_FLEncoder_WriteArrayValue = ffi.Bool Function(
    imp$1.FLEncoder encoder, imp$1.FLArray array, ffi.Uint32 index);
typedef DartCBLDart_FLEncoder_WriteArrayValue = bool Function(
    imp$1.FLEncoder encoder, imp$1.FLArray array, int index);
...
typedef NativeCBLDart_Completer_Complete = ffi.Void Function(
    CBLDart_Completer completer, ffi.Uint64 result);
typedef DartCBLDart_Completer_Complete = void Function(
    CBLDart_Completer completer, int result);
...
typedef DartCBLDart_CBLQuery_AddChangeListener
    = ffi.Pointer<CBLListenerToken> Function(ffi.Pointer<CBLDatabase> db,
        ffi.Pointer<CBLQuery> query, CBLDart_AsyncCallback listener);
typedef CBLDart_PredictiveModel_PredictionSyncFunction = imp$1.FLMutableDict
    Function(imp$1.FLDict input);
...
typedef CBLDart_PredictiveModel_PredictionAsyncFunction = ffi.Void Function(
    imp$1.FLDict input, CBLDart_Completer completer);
...
typedef CBLDartListenerPasswordAuthCallbackFunction = ffi.Void Function(
    ...
    imp$1.FLString username,
    imp$1.FLString password);
typedef DartCBLDartListenerPasswordAuthCallbackFunction = void Function(
    CBLDart_Completer completer,
    imp$1.FLString username,
    imp$1.FLString password);
typedef CBLDartListenerPasswordAuthCallback = ffi
    .Pointer<ffi.NativeFunction<CBLDartListenerPasswordAuthCallbackFunction>>;
typedef NativeCBLDart_ListenerPasswordAuthCallbackTrampoline
    = ffi.Bool Function(ffi.Pointer<ffi.Void> context, imp$1.FLString username,
        imp$1.FLString password);
typedef DartCBLDart_ListenerPasswordAuthCallbackTrampoline = bool Function(
    ffi.Pointer<ffi.Void> context,
    imp$1.FLString username,
    imp$1.FLString password);
typedef CBLCert = imp$1.CBLCert;
typedef CBLDartListenerCertAuthCallbackFunction = ffi.Void Function(
    CBLDart_Completer completer, ffi.Pointer<CBLCert> cert);
typedef DartCBLDartListenerCertAuthCallbackFunction = void Function(
    CBLDart_Completer completer, ffi.Pointer<CBLCert> cert);
typedef CBLDartListenerCertAuthCallback
    = ffi.Pointer<ffi.NativeFunction<CBLDartListenerCertAuthCallbackFunction>>;
typedef NativeCBLDart_ListenerCertAuthCallbackTrampoline = ffi.Bool Function(
    ffi.Pointer<ffi.Void> context, ffi.Pointer<CBLCert> cert);
typedef DartCBLDart_ListenerCertAuthCallbackTrampoline = bool Function(
    ffi.Pointer<ffi.Void> context, ffi.Pointer<CBLCert> cert);
