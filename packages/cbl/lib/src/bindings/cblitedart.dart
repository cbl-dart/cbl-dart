...
class cblitedart {
  ...
  late final ffi.Pointer<ffi.Pointer<KnownSharedKeys>> _CBLDart_struct =
      _lookup<ffi.Pointer<KnownSharedKeys>>('CBLDart_struct');

  ffi.Pointer<KnownSharedKeys> get CBLDart_struct => _CBLDart_struct.value;

  set CBLDart_struct(ffi.Pointer<KnownSharedKeys> value) =>
      _CBLDart_struct.value = value;
  ...
  ffi.Pointer<CBLDart_FLDictIterator> CBLDart_FLDictIterator_Begin(
    imp1.FLDict dict,
    ffi.Pointer<KnownSharedKeys> arg1,
  ) {
...
typedef NativeCBLDart_FLDictIterator_Begin = ffi.Pointer<CBLDart_FLDictIterator>
    Function(imp1.FLDict dict, ffi.Pointer<KnownSharedKeys> arg1);
typedef DartCBLDart_FLDictIterator_Begin = ffi.Pointer<CBLDart_FLDictIterator>
    Function(imp1.FLDict dict, ffi.Pointer<KnownSharedKeys> arg1);
