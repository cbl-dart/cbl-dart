...
class cbliteNativeAssetsBridge implements cblite {
  ...
  FLSliceResult CBLError_Message(ffi.Pointer<CBLError> outError) =>
      native.CBLError_Message(outError);
  ...
  ffi.Pointer<CBLRefCounted> CBL_Retain(ffi.Pointer<CBLRefCounted> arg0) =>
      native.CBL_Retain(arg0);

  @override
  void CBL_Release(ffi.Pointer<CBLRefCounted> arg0) => native.CBL_Release(arg0);
  ...
  void CBLListener_Remove(ffi.Pointer<CBLListenerToken> arg0) =>
      native.CBLListener_Remove(arg0);
  ...
  int CBLBlobReader_Read(
    ...
    int maxLength,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLBlobReader_Read(stream, dst, maxLength, outError);
  ...
  bool CBLBlobWriter_Write(
    ...
    int length,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLBlobWriter_Write(writer, data, length, outError);

  @override
  ffi.Pointer<CBLBlob> CBLBlob_CreateWithStream(
    FLString contentType,
    ffi.Pointer<CBLBlobWriteStream> writer,
  ) => native.CBLBlob_CreateWithStream(contentType, writer);

  @override
  void FLSlot_SetBlob(FLSlot slot, ffi.Pointer<CBLBlob> blob) =>
      native.FLSlot_SetBlob(slot, blob);
  ...
  ffi.Pointer<CBLBlob> CBLDatabase_GetBlob(
    ...
    FLDict properties,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLDatabase_GetBlob(db, properties, outError);
  ...
  bool CBLDatabase_SaveBlob(
    ...
    ffi.Pointer<CBLBlob> blob,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLDatabase_SaveBlob(db, blob, outError);
  ...
  ffi.Pointer<CBLVectorEncoding> CBLVectorEncoding_CreateScalarQuantizer(
    int type,
  ) => native.CBLVectorEncoding_CreateScalarQuantizer(type);

  @override
  ffi.Pointer<CBLVectorEncoding> CBLVectorEncoding_CreateProductQuantizer(
    int subquantizers,
    int bits,
  ) => native.CBLVectorEncoding_CreateProductQuantizer(subquantizers, bits);

  @override
  void CBLVectorEncoding_Free(ffi.Pointer<CBLVectorEncoding> arg0) =>
      native.CBLVectorEncoding_Free(arg0);
  ...
  FLMutableArray CBLDatabase_ScopeNames(
    ffi.Pointer<CBLDatabase> db,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLDatabase_ScopeNames(db, outError);
  ...
  FLMutableArray CBLDatabase_CollectionNames(
    ...
    FLString scopeName,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLDatabase_CollectionNames(db, scopeName, outError);
  ...
  ffi.Pointer<CBLScope> CBLDatabase_Scope(
    ...
    FLString scopeName,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLDatabase_Scope(db, scopeName, outError);
  ...
  ffi.Pointer<CBLCollection> CBLDatabase_Collection(
    ...
    FLString scopeName,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLDatabase_Collection(db, collectionName, scopeName, outError);
  ...
  ffi.Pointer<CBLDocument> CBLCollection_GetDocument(
    ...
    FLString docID,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLCollection_GetDocument(collection, docID, outError);
  ...
  bool CBLCollection_SaveDocument(
    ...
    ffi.Pointer<CBLDocument> doc,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLCollection_SaveDocument(collection, doc, outError);
  ...
  bool CBLCollection_DeleteDocument(
    ...
    ffi.Pointer<CBLDocument> document,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLCollection_DeleteDocument(collection, document, outError);
  ...
  bool CBLCollection_PurgeDocument(
    ...
    ffi.Pointer<CBLDocument> document,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLCollection_PurgeDocument(collection, document, outError);
  ...
  bool CBLCollection_PurgeDocumentByID(
    ...
    FLString docID,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLCollection_PurgeDocumentByID(collection, docID, outError);
  ...
  int CBLCollection_GetDocumentExpiration(
    ...
    FLSlice docID,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLCollection_GetDocumentExpiration(collection, docID, outError);
  ...
  ffi.Pointer<CBLDocument> CBLCollection_GetMutableDocument(
    ...
    FLString docID,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLCollection_GetMutableDocument(collection, docID, outError);
  ...
  bool CBLCollection_CreateValueIndex(
    ...
    ffi.Pointer<CBLError> outError,
      ...
      native.CBLCollection_CreateValueIndex(collection, name, config, outError);
  ...
  bool CBLCollection_CreateArrayIndex(
    ...
    ffi.Pointer<CBLError> outError,
      ...
      native.CBLCollection_CreateArrayIndex(collection, name, config, outError);
  ...
  bool CBLCollection_DeleteIndex(
    ...
    FLString name,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLCollection_DeleteIndex(collection, name, outError);

  @override
  FLMutableArray CBLCollection_GetIndexNames(
    ffi.Pointer<CBLCollection> collection,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLCollection_GetIndexNames(collection, outError);
  ...
  ffi.Pointer<CBLQueryIndex> CBLCollection_GetIndex(
    ...
    FLString name,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLCollection_GetIndex(collection, name, outError);
  ...
  ffi.Pointer<CBLListenerToken> CBLCollection_AddChangeListener(
    ...
    ffi.Pointer<ffi.Void> context,
  ) => native.CBLCollection_AddChangeListener(collection, listener, context);
  ...
  bool CBL_EnableVectorSearch(FLString path, ffi.Pointer<CBLError> outError) =>
      native.CBL_EnableVectorSearch(path, outError);
  ...
  bool CBLEncryptionKey_FromPassword(
    ...
    FLString password,
  ) => native.CBLEncryptionKey_FromPassword(key, password);

  @override
  bool CBLEncryptionKey_FromPasswordOld(
    ffi.Pointer<CBLEncryptionKey> key,
    FLString password,
  ) => native.CBLEncryptionKey_FromPasswordOld(key, password);

  @override
  bool CBL_DatabaseExists(FLString name, FLString inDirectory) =>
      native.CBL_DatabaseExists(name, inDirectory);
  ...
  bool CBL_CopyDatabase(
    ...
    ffi.Pointer<CBLError> outError,
  ) => native.CBL_CopyDatabase(fromPath, toName, config, outError);
  ...
  bool CBL_DeleteDatabase(
    ...
    ffi.Pointer<CBLError> outError,
  ) => native.CBL_DeleteDatabase(name, inDirectory, outError);
  ...
  ffi.Pointer<CBLDatabase> CBLDatabase_Open(
    ...
    ffi.Pointer<CBLDatabaseConfiguration> config,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLDatabase_Open(name, config, outError);

  @override
  bool CBLDatabase_Close(
    ffi.Pointer<CBLDatabase> arg0,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLDatabase_Close(arg0, outError);

  @override
  bool CBLDatabase_Delete(
    ffi.Pointer<CBLDatabase> arg0,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLDatabase_Delete(arg0, outError);

  @override
  bool CBLDatabase_BeginTransaction(
    ffi.Pointer<CBLDatabase> arg0,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLDatabase_BeginTransaction(arg0, outError);
  ...
  bool CBLDatabase_EndTransaction(
    ...
    bool commit,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLDatabase_EndTransaction(arg0, commit, outError);
  ...
  bool CBLDatabase_ChangeEncryptionKey(
    ...
    ffi.Pointer<CBLError> outError,
  ) => native.CBLDatabase_ChangeEncryptionKey(arg0, newKey, outError);
  ...
  bool CBLDatabase_PerformMaintenance(
    ...
    int type,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLDatabase_PerformMaintenance(db, type, outError);

  @override
  FLString CBLDatabase_Name(ffi.Pointer<CBLDatabase> arg0) =>
      native.CBLDatabase_Name(arg0);
  ...
  void CBLDatabase_BufferNotifications(
    ...
    ffi.Pointer<ffi.Void> context,
  ) => native.CBLDatabase_BufferNotifications(db, callback, context);

  @override
  void CBLDatabase_SendNotifications(ffi.Pointer<CBLDatabase> db) =>
      native.CBLDatabase_SendNotifications(db);
  ...
  ) => native.CBLCert_ValidTimespan(cert, outCreated, outExpires);

  @override
  ffi.Pointer<CBLKeyPair> CBLCert_PublicKey(ffi.Pointer<CBLCert> arg0) =>
      native.CBLCert_PublicKey(arg0);
  ...
  bool CBLTLSIdentity_DeleteIdentityWithLabel(
    FLString label,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLTLSIdentity_DeleteIdentityWithLabel(label, outError);

  @override
  ffi.Pointer<CBLTLSIdentity> CBLTLSIdentity_IdentityWithLabel(
    FLString label,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLTLSIdentity_IdentityWithLabel(label, outError);
  ...
  ffi.Pointer<CBLTLSIdentity> CBLTLSIdentity_IdentityWithCerts(
    ffi.Pointer<CBLCert> cert,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLTLSIdentity_IdentityWithCerts(cert, outError);
  ...
  @override
  void set CBLDefaultConflictResolver(CBLConflictResolver value) =>
  ...
  FLDict CBLReplicator_PendingDocumentIDs2(
    ...
    ffi.Pointer<CBLCollection> collection,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLReplicator_PendingDocumentIDs2(arg0, collection, outError);
  ...
  ffi.Pointer<CBLListenerToken> CBLReplicator_AddChangeListener(
    ...
    ffi.Pointer<ffi.Void> context,
  ) => native.CBLReplicator_AddChangeListener(arg0, arg1, context);
  ...
  ffi.Pointer<CBLListenerToken> CBLReplicator_AddDocumentReplicationListener(
    ...
    ffi.Pointer<ffi.Void> context,
  ) => native.CBLReplicator_AddDocumentReplicationListener(arg0, arg1, context);

  @override
  ffi.Pointer<CBLCert> CBLReplicator_ServerCertificate(
    ffi.Pointer<CBLReplicator> arg0,
  ) => native.CBLReplicator_ServerCertificate(arg0);
  ...
  void CBLLogSinks_SetCustom(CBLCustomLogSink sink) =>
      native.CBLLogSinks_SetCustom(sink);
  ...
  void CBLLogSinks_SetFile(CBLFileLogSink sink) =>
      native.CBLLogSinks_SetFile(sink);
  ...
  void CBL_Log(int domain, int level, ffi.Pointer<ffi.Char> format) =>
      native.CBL_Log(domain, level, format);
  ...
  void CBL_RegisterPredictiveModel(FLString name, CBLPredictiveModel model) =>
      native.CBL_RegisterPredictiveModel(name, model);

  @override
  void CBL_UnregisterPredictiveModel(FLString name) =>
      native.CBL_UnregisterPredictiveModel(name);
  ...
  ffi.Pointer<CBLListenerToken> CBLQuery_AddChangeListener(
    ...
    ffi.Pointer<ffi.Void> context,
  ) => native.CBLQuery_AddChangeListener(query, listener, context);
  ...
  ffi.Pointer<CBLIndexUpdater> CBLQueryIndex_BeginUpdate(
    ...
    int limit,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLQueryIndex_BeginUpdate(index, limit, outError);

  @override
  int CBLIndexUpdater_Count(ffi.Pointer<CBLIndexUpdater> updater) =>
      native.CBLIndexUpdater_Count(updater);

  @override
  FLValue CBLIndexUpdater_Value(
    ffi.Pointer<CBLIndexUpdater> updater,
    int index,
  ) => native.CBLIndexUpdater_Value(updater, index);
  ...
  void CBLIndexUpdater_SkipVector(
    ffi.Pointer<CBLIndexUpdater> updater,
    int index,
  ) => native.CBLIndexUpdater_SkipVector(updater, index);

  @override
  bool CBLIndexUpdater_Finish(
    ffi.Pointer<CBLIndexUpdater> updater,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLIndexUpdater_Finish(updater, outError);
  ...
  FLMutableArray CBLURLEndpointListener_Urls(
    ffi.Pointer<CBLURLEndpointListener> arg0,
  ) => native.CBLURLEndpointListener_Urls(arg0);

  @override
  CBLConnectionStatus CBLURLEndpointListener_Status(
    ffi.Pointer<CBLURLEndpointListener> arg0,
  ) => native.CBLURLEndpointListener_Status(arg0);

  @override
  bool CBLURLEndpointListener_Start(
    ffi.Pointer<CBLURLEndpointListener> arg0,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLURLEndpointListener_Start(arg0, outError);

  @override
  void CBLURLEndpointListener_Stop(ffi.Pointer<CBLURLEndpointListener> arg0) =>
      native.CBLURLEndpointListener_Stop(arg0);

  @override
  bool FLSlice_Equal(FLSlice a, FLSlice b) => native.FLSlice_Equal(a, b);

  @override
  int FLSlice_Compare(FLSlice arg0, FLSlice arg1) =>
      native.FLSlice_Compare(arg0, arg1);

  @override
  int FLSlice_Hash(FLSlice s) => native.FLSlice_Hash(s);
  ...
  bool FLSlice_ToCString(
    ...
    int capacity,
  ) => native.FLSlice_ToCString(s, buffer, capacity);

  @override
  FLSliceResult FLSliceResult_New(int arg0) => native.FLSliceResult_New(arg0);

  @override
  FLSliceResult FLSlice_Copy(FLSlice arg0) => native.FLSlice_Copy(arg0);

  @override
  void FLBuf_Retain(ffi.Pointer<ffi.Void> arg0) => native.FLBuf_Retain(arg0);

  @override
  void FLBuf_Release(ffi.Pointer<ffi.Void> arg0) => native.FLBuf_Release(arg0);

  @override
  void FL_WipeMemory(ffi.Pointer<ffi.Void> dst, int size) =>
      native.FL_WipeMemory(dst, size);
  ...
  ) => native.FLDeepIterator_GetPath(arg0, outPath, outDepth);

  @override
  FLSliceResult FLDeepIterator_GetPathString(FLDeepIterator arg0) =>
      native.FLDeepIterator_GetPathString(arg0);

  @override
  FLSliceResult FLDeepIterator_GetJSONPointer(FLDeepIterator arg0) =>
      native.FLDeepIterator_GetJSONPointer(arg0);
  ...
  FLDoc FLDoc_FromResultData(
    ...
    FLSharedKeys arg2,
    FLSlice externData,
  ) => native.FLDoc_FromResultData(data, arg1, arg2, externData);

  @override
  void FLDoc_Release(FLDoc arg0) => native.FLDoc_Release(arg0);
  ...
  FLSharedKeys FLDoc_GetSharedKeys(FLDoc arg0) =>
      native.FLDoc_GetSharedKeys(arg0);

  @override
  FLDoc FLValue_FindDoc(FLValue arg0) => native.FLValue_FindDoc(arg0);
  ...
  ) => native.FLDoc_SetAssociated(doc, pointer, type);

  @override
  ffi.Pointer<ffi.Void> FLDoc_GetAssociated(
    FLDoc doc,
    ffi.Pointer<ffi.Char> type,
  ) => native.FLDoc_GetAssociated(doc, type);
  ...
  FLEncoder FLEncoder_NewWithOptions(
    ...
    int reserveSize,
    bool uniqueStrings,
  ) => native.FLEncoder_NewWithOptions(format, reserveSize, uniqueStrings);

  @override
  FLEncoder FLEncoder_NewWritingToFile(
    ffi.Pointer<FILE> arg0,
    bool uniqueStrings,
  ) => native.FLEncoder_NewWritingToFile(arg0, uniqueStrings);

  @override
  void FLEncoder_Free(FLEncoder arg0) => native.FLEncoder_Free(arg0);

  @override
  void FLEncoder_SetSharedKeys(FLEncoder arg0, FLSharedKeys arg1) =>
      native.FLEncoder_SetSharedKeys(arg0, arg1);

  @override
  void FLEncoder_SetExtraInfo(FLEncoder arg0, ffi.Pointer<ffi.Void> info) =>
      native.FLEncoder_SetExtraInfo(arg0, info);

  @override
  ffi.Pointer<ffi.Void> FLEncoder_GetExtraInfo(FLEncoder arg0) =>
      native.FLEncoder_GetExtraInfo(arg0);

  @override
  void FLEncoder_Reset(FLEncoder arg0) => native.FLEncoder_Reset(arg0);

  @override
  int FLEncoder_BytesWritten(FLEncoder arg0) =>
      native.FLEncoder_BytesWritten(arg0);

  @override
  bool FLEncoder_WriteNull(FLEncoder arg0) => native.FLEncoder_WriteNull(arg0);

  @override
  bool FLEncoder_WriteUndefined(FLEncoder arg0) =>
      native.FLEncoder_WriteUndefined(arg0);

  @override
  bool FLEncoder_WriteBool(FLEncoder arg0, bool arg1) =>
      native.FLEncoder_WriteBool(arg0, arg1);

  @override
  bool FLEncoder_WriteInt(FLEncoder arg0, int arg1) =>
      native.FLEncoder_WriteInt(arg0, arg1);

  @override
  bool FLEncoder_WriteUInt(FLEncoder arg0, int arg1) =>
      native.FLEncoder_WriteUInt(arg0, arg1);

  @override
  bool FLEncoder_WriteFloat(FLEncoder arg0, double arg1) =>
      native.FLEncoder_WriteFloat(arg0, arg1);

  @override
  bool FLEncoder_WriteDouble(FLEncoder arg0, double arg1) =>
      native.FLEncoder_WriteDouble(arg0, arg1);

  @override
  bool FLEncoder_WriteString(FLEncoder arg0, FLString arg1) =>
      native.FLEncoder_WriteString(arg0, arg1);

  @override
  bool FLEncoder_WriteDateString(FLEncoder encoder, int ts, bool asUTC) =>
      native.FLEncoder_WriteDateString(encoder, ts, asUTC);

  @override
  bool FLEncoder_WriteData(FLEncoder arg0, FLSlice arg1) =>
      native.FLEncoder_WriteData(arg0, arg1);
  ...
  @override
  bool FLEncoder_EndArray(FLEncoder arg0) => native.FLEncoder_EndArray(arg0);

  @override
  bool FLEncoder_BeginDict(FLEncoder arg0, int reserveCount) =>
      native.FLEncoder_BeginDict(arg0, reserveCount);

  @override
  bool FLEncoder_WriteKey(FLEncoder arg0, FLString arg1) =>
      native.FLEncoder_WriteKey(arg0, arg1);

  @override
  bool FLEncoder_WriteKeyValue(FLEncoder arg0, FLValue arg1) =>
      native.FLEncoder_WriteKeyValue(arg0, arg1);

  @override
  bool FLEncoder_EndDict(FLEncoder arg0) => native.FLEncoder_EndDict(arg0);

  @override
  bool FLEncoder_WriteRaw(FLEncoder arg0, FLSlice arg1) =>
      native.FLEncoder_WriteRaw(arg0, arg1);

  @override
  FLDoc FLEncoder_FinishDoc(
    FLEncoder arg0,
    ffi.Pointer<ffi.UnsignedInt> outError,
  ) => native.FLEncoder_FinishDoc(arg0, outError);

  @override
  FLSliceResult FLEncoder_Finish(
    FLEncoder arg0,
    ffi.Pointer<ffi.UnsignedInt> outError,
  ) => native.FLEncoder_Finish(arg0, outError);
  ...
  @override
  FLStringResult FLValue_ToJSON5(FLValue arg0) => native.FLValue_ToJSON5(arg0);

  @override
  FLStringResult FLValue_ToJSONX(FLValue v, bool json5, bool canonicalForm) =>
      native.FLValue_ToJSONX(v, json5, canonicalForm);

  @override
  FLDoc FLDoc_FromJSON(FLSlice json, ffi.Pointer<ffi.UnsignedInt> outError) =>
      native.FLDoc_FromJSON(json, outError);

  @override
  FLMutableArray FLMutableArray_NewFromJSON(
    FLString json,
    ffi.Pointer<ffi.UnsignedInt> outError,
  ) => native.FLMutableArray_NewFromJSON(json, outError);

  @override
  FLMutableDict FLMutableDict_NewFromJSON(
    FLString json,
    ffi.Pointer<ffi.UnsignedInt> outError,
  ) => native.FLMutableDict_NewFromJSON(json, outError);

  @override
  bool FLEncoder_ConvertJSON(FLEncoder arg0, FLSlice json) =>
      native.FLEncoder_ConvertJSON(arg0, json);

  @override
  FLKeyPath FLKeyPath_New(
    FLSlice specifier,
    ffi.Pointer<ffi.UnsignedInt> outError,
  ) => native.FLKeyPath_New(specifier, outError);

  @override
  void FLKeyPath_Free(FLKeyPath arg0) => native.FLKeyPath_Free(arg0);

  @override
  FLValue FLKeyPath_Eval(FLKeyPath arg0, FLValue root) =>
      native.FLKeyPath_Eval(arg0, root);
  ...
  FLValue FLKeyPath_EvalOnce(
    ...
    FLValue root,
    ffi.Pointer<ffi.UnsignedInt> outError,
  ) => native.FLKeyPath_EvalOnce(specifier, root, outError);

  @override
  FLStringResult FLKeyPath_ToString(FLKeyPath path) =>
      native.FLKeyPath_ToString(path);
  ...
  @override
  void set kFLNullValue(FLValue value) => native.kFLNullValue = value;

  @override
  FLValue get kFLUndefinedValue => native.kFLUndefinedValue;

  @override
  void set kFLUndefinedValue(FLValue value) => native.kFLUndefinedValue = value;

  @override
  int FLValue_GetType(FLValue arg0) => native.FLValue_GetType(arg0);

  @override
  bool FLValue_IsInteger(FLValue arg0) => native.FLValue_IsInteger(arg0);

  @override
  bool FLValue_IsUnsigned(FLValue arg0) => native.FLValue_IsUnsigned(arg0);

  @override
  bool FLValue_IsDouble(FLValue arg0) => native.FLValue_IsDouble(arg0);

  @override
  bool FLValue_AsBool(FLValue arg0) => native.FLValue_AsBool(arg0);

  @override
  int FLValue_AsInt(FLValue arg0) => native.FLValue_AsInt(arg0);

  @override
  int FLValue_AsUnsigned(FLValue arg0) => native.FLValue_AsUnsigned(arg0);

  @override
  double FLValue_AsFloat(FLValue arg0) => native.FLValue_AsFloat(arg0);

  @override
  double FLValue_AsDouble(FLValue arg0) => native.FLValue_AsDouble(arg0);

  @override
  FLString FLValue_AsString(FLValue arg0) => native.FLValue_AsString(arg0);

  @override
  int FLValue_AsTimestamp(FLValue arg0) => native.FLValue_AsTimestamp(arg0);

  @override
  FLSlice FLValue_AsData(FLValue arg0) => native.FLValue_AsData(arg0);

  @override
  FLArray FLValue_AsArray(FLValue arg0) => native.FLValue_AsArray(arg0);

  @override
  FLDict FLValue_AsDict(FLValue arg0) => native.FLValue_AsDict(arg0);

  @override
  FLStringResult FLValue_ToString(FLValue arg0) =>
      native.FLValue_ToString(arg0);

  @override
  bool FLValue_IsEqual(FLValue v1, FLValue v2) =>
      native.FLValue_IsEqual(v1, v2);

  @override
  bool FLValue_IsMutable(FLValue arg0) => native.FLValue_IsMutable(arg0);

  @override
  FLValue FLValue_Retain(FLValue arg0) => native.FLValue_Retain(arg0);

  @override
  void FLValue_Release(FLValue arg0) => native.FLValue_Release(arg0);

  @override
  FLMutableArray FLArray_MutableCopy(FLArray arg0, int arg1) =>
      native.FLArray_MutableCopy(arg0, arg1);
  ...
  FLDict FLMutableDict_GetSource(FLMutableDict arg0) =>
      native.FLMutableDict_GetSource(arg0);

  @override
  bool FLMutableDict_IsChanged(FLMutableDict arg0) =>
      native.FLMutableDict_IsChanged(arg0);

  @override
  void FLMutableDict_SetChanged(FLMutableDict arg0, bool arg1) =>
      native.FLMutableDict_SetChanged(arg0, arg1);

  @override
  void FLMutableDict_Remove(FLMutableDict arg0, FLString key) =>
      native.FLMutableDict_Remove(arg0, key);

  @override
  void FLMutableDict_RemoveAll(FLMutableDict arg0) =>
      native.FLMutableDict_RemoveAll(arg0);

  @override
  FLMutableArray FLMutableDict_GetMutableArray(
    FLMutableDict arg0,
    FLString key,
  ) => native.FLMutableDict_GetMutableArray(arg0, key);

  @override
  FLMutableDict FLMutableDict_GetMutableDict(
    FLMutableDict arg0,
    FLString key,
  ) => native.FLMutableDict_GetMutableDict(arg0, key);

  @override
  FLValue FLValue_NewString(FLString arg0) => native.FLValue_NewString(arg0);

  @override
  FLValue FLValue_NewData(FLSlice arg0) => native.FLValue_NewData(arg0);

  @override
  FLSlot FLMutableArray_Set(FLMutableArray arg0, int index) =>
      native.FLMutableArray_Set(arg0, index);

  @override
  FLSlot FLMutableArray_Append(FLMutableArray arg0) =>
      native.FLMutableArray_Append(arg0);

  @override
  FLSlot FLMutableDict_Set(FLMutableDict arg0, FLString key) =>
      native.FLMutableDict_Set(arg0, key);

  @override
  void FLSlot_SetNull(FLSlot arg0) => native.FLSlot_SetNull(arg0);

  @override
  void FLSlot_SetBool(FLSlot arg0, bool arg1) =>
      native.FLSlot_SetBool(arg0, arg1);

  @override
  void FLSlot_SetInt(FLSlot arg0, int arg1) => native.FLSlot_SetInt(arg0, arg1);

  @override
  void FLSlot_SetUInt(FLSlot arg0, int arg1) =>
      native.FLSlot_SetUInt(arg0, arg1);

  @override
  void FLSlot_SetFloat(FLSlot arg0, double arg1) =>
      native.FLSlot_SetFloat(arg0, arg1);

  @override
  void FLSlot_SetDouble(FLSlot arg0, double arg1) =>
      native.FLSlot_SetDouble(arg0, arg1);

  @override
  void FLSlot_SetString(FLSlot arg0, FLString arg1) =>
      native.FLSlot_SetString(arg0, arg1);

  @override
  void FLSlot_SetData(FLSlot arg0, FLSlice arg1) =>
      native.FLSlot_SetData(arg0, arg1);
  ...
  FLSliceResult FLCreateJSONDelta(FLValue old, FLValue nuu) =>
      native.FLCreateJSONDelta(old, nuu);

  @override
  bool FLEncodeJSONDelta(FLValue old, FLValue nuu, FLEncoder jsonEncoder) =>
      native.FLEncodeJSONDelta(old, nuu, jsonEncoder);
  ...
  FLSliceResult FLApplyJSONDelta(
    ...
    FLSlice jsonDelta,
    ffi.Pointer<ffi.UnsignedInt> outError,
  ) => native.FLApplyJSONDelta(old, jsonDelta, outError);
  ...
  bool FLEncodeApplyingJSONDelta(
    ...
    FLSlice jsonDelta,
    FLEncoder encoder,
  ) => native.FLEncodeApplyingJSONDelta(old, jsonDelta, encoder);
  ...
  FLStringResult FLJSON5_ToJSON(
    ...
    ffi.Pointer<ffi.UnsignedInt> outError,
  ) => native.FLJSON5_ToJSON(json5, outErrorMessage, outErrorPos, outError);

  @override
  FLSliceResult FLData_ConvertJSON(
    FLSlice json,
    ffi.Pointer<ffi.UnsignedInt> outError,
  ) => native.FLData_ConvertJSON(json, outError);
  ...
  void FLEncoder_Amend(
    ...
    bool reuseStrings,
    bool externPointers,
  ) => native.FLEncoder_Amend(e, base, reuseStrings, externPointers);

  @override
  FLSlice FLEncoder_GetBase(FLEncoder arg0) => native.FLEncoder_GetBase(arg0);

  @override
  void FLEncoder_SuppressTrailer(FLEncoder arg0) =>
      native.FLEncoder_SuppressTrailer(arg0);

  @override
  int FLEncoder_GetNextWritePos(FLEncoder arg0) =>
      native.FLEncoder_GetNextWritePos(arg0);

  @override
  int FLEncoder_LastValueWritten(FLEncoder arg0) =>
      native.FLEncoder_LastValueWritten(arg0);

  @override
  bool FLEncoder_WriteValueAgain(FLEncoder arg0, int preWrittenValue) =>
      native.FLEncoder_WriteValueAgain(arg0, preWrittenValue);

  @override
  FLSliceResult FLEncoder_Snip(FLEncoder arg0) => native.FLEncoder_Snip(arg0);

  @override
  int FLEncoder_FinishItem(FLEncoder arg0) => native.FLEncoder_FinishItem(arg0);

  @override
  void FLJSONEncoder_NextDocument(FLEncoder arg0) =>
      native.FLJSONEncoder_NextDocument(arg0);

  @override
  ffi.Pointer<ffi.Char> FLDump(FLValue arg0) => native.FLDump(arg0);

  @override
  ffi.Pointer<ffi.Char> FLDumpData(FLSlice data) => native.FLDumpData(data);
