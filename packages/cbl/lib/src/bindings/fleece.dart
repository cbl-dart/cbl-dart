...
enum FLError {
  ...
  static FLError fromValue(int value) => switch (value) {
    ...
    cblite_lib.FLError.kFLSharedKeysStateError => sharedKeysStateError,
    cblite_lib.FLError.kFLPOSIXError => posixError,
    cblite_lib.FLError.kFLUnsupported => unsupported,
