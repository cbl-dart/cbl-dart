...
external imp$1.DartCBLTimestamp CBL_Now();
...
external bool FLDict_IsBlob(imp$1.FLDict arg0);

@ffi.Native<NativeFLDict_GetBlob>()
external ffi.Pointer<CBLBlob> FLDict_GetBlob(imp$1.FLDict blobDict);

@ffi.Native<NativeCBLBlob_Length>()
external int CBLBlob_Length(ffi.Pointer<CBLBlob> arg0);

@ffi.Native<NativeCBLBlob_ContentType>()
external imp$1.FLString CBLBlob_ContentType(ffi.Pointer<CBLBlob> arg0);

@ffi.Native<NativeCBLBlob_Digest>()
external imp$1.FLString CBLBlob_Digest(ffi.Pointer<CBLBlob> arg0);

@ffi.Native<NativeCBLBlob_Properties>()
external imp$1.FLDict CBLBlob_Properties(ffi.Pointer<CBLBlob> arg0);

@ffi.Native<NativeCBLBlob_CreateJSON>()
external imp$1.FLStringResult CBLBlob_CreateJSON(ffi.Pointer<CBLBlob> blob);
...
external void FLSlot_SetBlob(imp$1.FLSlot slot, ffi.Pointer<CBLBlob> blob);

@ffi.Native<NativeCBLDatabase_GetBlob>()
external ffi.Pointer<CBLBlob> CBLDatabase_GetBlob(
  ffi.Pointer<CBLDatabase> db,
  imp$1.FLDict properties,
  ffi.Pointer<CBLError> outError,
);
...
external imp$1.FLString CBLDocument_ID(ffi.Pointer<CBLDocument> arg0);

@ffi.Native<NativeCBLDocument_RevisionID>()
external imp$1.FLString CBLDocument_RevisionID(ffi.Pointer<CBLDocument> arg0);

@ffi.Native<NativeCBLDocument_Timestamp>()
...
external imp$1.FLDict CBLDocument_Properties(ffi.Pointer<CBLDocument> arg0);

@ffi.Native<NativeCBLDocument_MutableProperties>()
external imp$1.FLMutableDict CBLDocument_MutableProperties(
  ffi.Pointer<CBLDocument> arg0,
);
...
external void CBLDocument_SetProperties(
  ffi.Pointer<CBLDocument> arg0,
  imp$1.FLMutableDict properties,
);
...
external ffi.Pointer<CBLVectorEncoding> CBLVectorEncoding_CreateScalarQuantizer(
  imp$1.DartCBLScalarQuantizerType type,
);
...
external bool CBLCollection_SaveDocumentWithConcurrencyControl(
  ffi.Pointer<CBLCollection> collection,
  ffi.Pointer<CBLDocument> doc,
  imp$1.DartCBLConcurrencyControl concurrency,
  ffi.Pointer<CBLError> outError,
);
...
external bool CBLCollection_SaveDocumentWithConflictHandler(
  ffi.Pointer<CBLCollection> collection,
  ffi.Pointer<CBLDocument> doc,
  imp$1.CBLConflictHandler conflictHandler,
...
external ffi.Pointer<CBLListenerToken> CBLCollection_AddDocumentChangeListener(
  ffi.Pointer<CBLCollection> collection,
  imp$1.FLString docID,
  imp$1.CBLCollectionDocumentChangeListener listener,
  ffi.Pointer<ffi.Void> context,
);
...
external void CBLDatabase_BufferNotifications(
  ffi.Pointer<CBLDatabase> db,
  imp$1.CBLNotificationsReadyCallback callback,
  ffi.Pointer<ffi.Void> context,
);
...
@ffi.Native<imp$1.CBLConflictResolver>()
external imp$1.CBLConflictResolver CBLDefaultConflictResolver;
...
external imp$1.FLDict CBLReplicator_PendingDocumentIDs(
  ffi.Pointer<CBLReplicator> arg0,
  ffi.Pointer<CBLCollection> collection,
  ffi.Pointer<CBLError> outError,
);
...
external imp$1.FLDict CBLReplicator_PendingDocumentIDs2(
  ffi.Pointer<CBLReplicator> arg0,
  ffi.Pointer<CBLCollection> collection,
  ffi.Pointer<CBLError> outError,
);
...
external ffi.Pointer<CBLListenerToken> CBLReplicator_AddChangeListener(
  ffi.Pointer<CBLReplicator> arg0,
  imp$1.CBLReplicatorChangeListener arg1,
  ffi.Pointer<ffi.Void> context,
);
...
@ffi.Native<imp$1.CBLReplicatorType>()
external final imp$1.DartCBLReplicatorType kCBLDefaultReplicatorType;
...
@ffi.Native<imp$1.CBLDistanceMetric>()
external final imp$1.DartCBLDistanceMetric kCBLDefaultVectorIndexDistanceMetric;
...
external void CBL_UnregisterPredictiveModel(imp$1.FLString name);
...
external void CBLQuery_SetParameters(
  ...
  imp$1.FLDict parameters,
);

@ffi.Native<NativeCBLQuery_Parameters>()
external imp$1.FLDict CBLQuery_Parameters(ffi.Pointer<CBLQuery> query);
...
external imp$1.FLValue CBLResultSet_ValueAtIndex(
  ffi.Pointer<CBLResultSet> arg0,
  int index,
);

@ffi.Native<NativeCBLResultSet_ValueForKey>()
external imp$1.FLValue CBLResultSet_ValueForKey(
  ffi.Pointer<CBLResultSet> arg0,
  imp$1.FLString key,
);

@ffi.Native<NativeCBLResultSet_ResultArray>()
external imp$1.FLArray CBLResultSet_ResultArray(ffi.Pointer<CBLResultSet> arg0);

@ffi.Native<NativeCBLResultSet_ResultDict>()
external imp$1.FLDict CBLResultSet_ResultDict(ffi.Pointer<CBLResultSet> arg0);
...
external ffi.Pointer<CBLListenerToken> CBLQuery_AddChangeListener(
  ffi.Pointer<CBLQuery> query,
  imp$1.CBLQueryChangeListener listener,
  ffi.Pointer<ffi.Void> context,
);
...
external imp$1.FLString CBLQueryIndex_Name(ffi.Pointer<CBLQueryIndex> index);
...
external imp$1.FLValue CBLIndexUpdater_Value(
...
@ffi.Native<imp$1.FLString>()
external final imp$1.FLString kCBLDefaultScopeName;

@ffi.Native<NativeCBLScope_Name>()
external imp$1.FLString CBLScope_Name(ffi.Pointer<CBLScope> scope);
...
external imp$1.FLMutableArray CBLScope_CollectionNames(
  ffi.Pointer<CBLScope> scope,
  ffi.Pointer<CBLError> outError,
);
...
external imp$1.DartFLTimestamp FLTimestamp_Now();

@ffi.Native<NativeFLTimestamp_ToString>()
external imp$1.FLStringResult FLTimestamp_ToString(
  imp$1.DartFLTimestamp timestamp,
  bool asUTC,
);

@ffi.Native<NativeFLTimestamp_FromString>()
external imp$1.DartFLTimestamp FLTimestamp_FromString(imp$1.FLString str);

@ffi.Native<imp$1.FLArray>()
external imp$1.FLArray kFLEmptyArray;

@ffi.Native<NativeFLArray_Count>()
external int FLArray_Count(imp$1.FLArray arg0);

@ffi.Native<NativeFLArray_IsEmpty>()
external bool FLArray_IsEmpty(imp$1.FLArray arg0);

@ffi.Native<NativeFLArray_AsMutable>()
external imp$1.FLMutableArray FLArray_AsMutable(imp$1.FLArray arg0);

@ffi.Native<NativeFLArray_Get>()
external imp$1.FLValue FLArray_Get(imp$1.FLArray arg0, int index);
...
external imp$1.FLValue FLArrayIterator_GetValue(
  ffi.Pointer<FLArrayIterator> arg0,
);

@ffi.Native<NativeFLArrayIterator_GetValueAt>()
external imp$1.FLValue FLArrayIterator_GetValueAt(
  ffi.Pointer<FLArrayIterator> arg0,
  int offset,
);
...
@ffi.Native<imp$1.FLDict>()
external imp$1.FLDict kFLEmptyDict;

@ffi.Native<NativeFLDict_Count>()
external int FLDict_Count(imp$1.FLDict arg0);

@ffi.Native<NativeFLDict_IsEmpty>()
external bool FLDict_IsEmpty(imp$1.FLDict arg0);

@ffi.Native<NativeFLDict_AsMutable>()
external imp$1.FLMutableDict FLDict_AsMutable(imp$1.FLDict arg0);

@ffi.Native<NativeFLDict_Get>()
external imp$1.FLValue FLDict_Get(imp$1.FLDict arg0, FLSlice keyString);
...
external imp$1.FLValue FLDictIterator_GetKey(ffi.Pointer<FLDictIterator> arg0);

@ffi.Native<NativeFLDictIterator_GetKeyString>()
external imp$1.FLString FLDictIterator_GetKeyString(
  ffi.Pointer<FLDictIterator> arg0,
);

@ffi.Native<NativeFLDictIterator_GetValue>()
external imp$1.FLValue FLDictIterator_GetValue(
  ffi.Pointer<FLDictIterator> arg0,
);
...
external imp$1.FLString FLDictKey_GetString(ffi.Pointer<FLDictKey> arg0);

@ffi.Native<NativeFLDict_GetWithKey>()
external imp$1.FLValue FLDict_GetWithKey(
  imp$1.FLDict arg0,
  ffi.Pointer<FLDictKey> arg1,
);

@ffi.Native<NativeFLDeepIterator_New>()
external imp$1.FLDeepIterator FLDeepIterator_New(imp$1.FLValue arg0);

@ffi.Native<NativeFLDeepIterator_Free>()
external void FLDeepIterator_Free(imp$1.FLDeepIterator arg0);

@ffi.Native<NativeFLDeepIterator_GetValue>()
external imp$1.FLValue FLDeepIterator_GetValue(imp$1.FLDeepIterator arg0);

@ffi.Native<NativeFLDeepIterator_GetParent>()
external imp$1.FLValue FLDeepIterator_GetParent(imp$1.FLDeepIterator arg0);

@ffi.Native<NativeFLDeepIterator_GetKey>()
external FLSlice FLDeepIterator_GetKey(imp$1.FLDeepIterator arg0);

@ffi.Native<NativeFLDeepIterator_GetIndex>()
external int FLDeepIterator_GetIndex(imp$1.FLDeepIterator arg0);

@ffi.Native<NativeFLDeepIterator_GetDepth>()
external int FLDeepIterator_GetDepth(imp$1.FLDeepIterator arg0);

@ffi.Native<NativeFLDeepIterator_SkipChildren>()
external void FLDeepIterator_SkipChildren(imp$1.FLDeepIterator arg0);

@ffi.Native<NativeFLDeepIterator_Next>()
external bool FLDeepIterator_Next(imp$1.FLDeepIterator arg0);

@ffi.Native<NativeFLDeepIterator_GetPath>()
external void FLDeepIterator_GetPath(
  imp$1.FLDeepIterator arg0,
...
external FLSliceResult FLDeepIterator_GetPathString(imp$1.FLDeepIterator arg0);

@ffi.Native<NativeFLDeepIterator_GetJSONPointer>()
external FLSliceResult FLDeepIterator_GetJSONPointer(imp$1.FLDeepIterator arg0);

@ffi.Native<NativeFLDoc_FromResultData>()
external imp$1.FLDoc FLDoc_FromResultData(
  FLSliceResult data,
  int arg1,
  imp$1.FLSharedKeys arg2,
  FLSlice externData,
);

@ffi.Native<NativeFLDoc_Release>()
external void FLDoc_Release(imp$1.FLDoc arg0);

@ffi.Native<NativeFLDoc_Retain>()
external imp$1.FLDoc FLDoc_Retain(imp$1.FLDoc arg0);

@ffi.Native<NativeFLDoc_GetData>()
external FLSlice FLDoc_GetData(imp$1.FLDoc doc);

@ffi.Native<NativeFLDoc_GetAllocedData>()
external FLSliceResult FLDoc_GetAllocedData(imp$1.FLDoc arg0);

@ffi.Native<NativeFLDoc_GetRoot>()
external imp$1.FLValue FLDoc_GetRoot(imp$1.FLDoc doc);

@ffi.Native<NativeFLDoc_GetSharedKeys>()
external imp$1.FLSharedKeys FLDoc_GetSharedKeys(imp$1.FLDoc arg0);

@ffi.Native<NativeFLValue_FindDoc>()
external imp$1.FLDoc FLValue_FindDoc(imp$1.FLValue arg0);
...
external imp$1.FLEncoder FLEncoder_New();

@ffi.Native<NativeFLEncoder_NewWithOptions>()
external imp$1.FLEncoder FLEncoder_NewWithOptions(
  int format,
  int reserveSize,
  bool uniqueStrings,
);
...
external imp$1.FLEncoder FLEncoder_NewWritingToFile(
  ffi.Pointer<imp$1.FILE> arg0,
  bool uniqueStrings,
);

@ffi.Native<NativeFLEncoder_Free>()
external void FLEncoder_Free(imp$1.FLEncoder arg0);

@ffi.Native<NativeFLEncoder_SetSharedKeys>()
external void FLEncoder_SetSharedKeys(
  imp$1.FLEncoder arg0,
  imp$1.FLSharedKeys arg1,
);
...
external ffi.Pointer<ffi.Void> FLEncoder_GetExtraInfo(imp$1.FLEncoder arg0);

@ffi.Native<NativeFLEncoder_Reset>()
external void FLEncoder_Reset(imp$1.FLEncoder arg0);

@ffi.Native<NativeFLEncoder_BytesWritten>()
external int FLEncoder_BytesWritten(imp$1.FLEncoder arg0);

@ffi.Native<NativeFLEncoder_WriteNull>()
external bool FLEncoder_WriteNull(imp$1.FLEncoder arg0);

@ffi.Native<NativeFLEncoder_WriteUndefined>()
external bool FLEncoder_WriteUndefined(imp$1.FLEncoder arg0);

@ffi.Native<NativeFLEncoder_WriteBool>()
external bool FLEncoder_WriteBool(imp$1.FLEncoder arg0, bool arg1);

@ffi.Native<NativeFLEncoder_WriteInt>()
external bool FLEncoder_WriteInt(imp$1.FLEncoder arg0, int arg1);

@ffi.Native<NativeFLEncoder_WriteUInt>()
external bool FLEncoder_WriteUInt(imp$1.FLEncoder arg0, int arg1);

@ffi.Native<NativeFLEncoder_WriteFloat>()
external bool FLEncoder_WriteFloat(imp$1.FLEncoder arg0, double arg1);

@ffi.Native<NativeFLEncoder_WriteDouble>()
external bool FLEncoder_WriteDouble(imp$1.FLEncoder arg0, double arg1);

@ffi.Native<NativeFLEncoder_WriteString>()
external bool FLEncoder_WriteString(imp$1.FLEncoder arg0, imp$1.FLString arg1);

@ffi.Native<NativeFLEncoder_WriteDateString>()
external bool FLEncoder_WriteDateString(
  imp$1.FLEncoder encoder,
  imp$1.DartFLTimestamp ts,
  bool asUTC,
);

@ffi.Native<NativeFLEncoder_WriteData>()
external bool FLEncoder_WriteData(imp$1.FLEncoder arg0, FLSlice arg1);

@ffi.Native<NativeFLEncoder_WriteValue>()
external bool FLEncoder_WriteValue(imp$1.FLEncoder arg0, imp$1.FLValue arg1);

@ffi.Native<NativeFLEncoder_WriteFormatted>()
external bool FLEncoder_WriteFormatted(
  imp$1.FLEncoder arg0,
  ffi.Pointer<ffi.Char> format,
);

@ffi.Native<NativeFLEncoder_WriteFormattedArgs>()
...
external bool FLEncoder_BeginArray(imp$1.FLEncoder arg0, int reserveCount);

@ffi.Native<NativeFLEncoder_EndArray>()
external bool FLEncoder_EndArray(imp$1.FLEncoder arg0);

@ffi.Native<NativeFLEncoder_BeginDict>()
external bool FLEncoder_BeginDict(imp$1.FLEncoder arg0, int reserveCount);

@ffi.Native<NativeFLEncoder_WriteKey>()
external bool FLEncoder_WriteKey(imp$1.FLEncoder arg0, imp$1.FLString arg1);

@ffi.Native<NativeFLEncoder_WriteKeyValue>()
external bool FLEncoder_WriteKeyValue(imp$1.FLEncoder arg0, imp$1.FLValue arg1);

@ffi.Native<NativeFLEncoder_EndDict>()
external bool FLEncoder_EndDict(imp$1.FLEncoder arg0);

@ffi.Native<NativeFLEncoder_WriteRaw>()
external bool FLEncoder_WriteRaw(imp$1.FLEncoder arg0, FLSlice arg1);

@ffi.Native<NativeFLEncoder_FinishDoc>()
external imp$1.FLDoc FLEncoder_FinishDoc(
  imp$1.FLEncoder arg0,
...
external int FLEncoder_GetError(imp$1.FLEncoder arg0);

@ffi.Native<NativeFLEncoder_GetErrorMessage>()
external ffi.Pointer<ffi.Char> FLEncoder_GetErrorMessage(imp$1.FLEncoder e);

@ffi.Native<NativeFLValue_ToJSON>()
external imp$1.FLStringResult FLValue_ToJSON(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_ToJSON5>()
external imp$1.FLStringResult FLValue_ToJSON5(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_ToJSONX>()
external imp$1.FLStringResult FLValue_ToJSONX(
  imp$1.FLValue v,
  bool json5,
  bool canonicalForm,
);
...
external imp$1.FLDoc FLDoc_FromJSON(
  FLSlice json,
  ffi.Pointer<ffi.UnsignedInt> outError,
);

@ffi.Native<NativeFLMutableArray_NewFromJSON>()
external imp$1.FLMutableArray FLMutableArray_NewFromJSON(
  imp$1.FLString json,
  ffi.Pointer<ffi.UnsignedInt> outError,
);

@ffi.Native<NativeFLMutableDict_NewFromJSON>()
external imp$1.FLMutableDict FLMutableDict_NewFromJSON(
  imp$1.FLString json,
  ffi.Pointer<ffi.UnsignedInt> outError,
);

@ffi.Native<NativeFLEncoder_ConvertJSON>()
external bool FLEncoder_ConvertJSON(imp$1.FLEncoder arg0, FLSlice json);

@ffi.Native<NativeFLKeyPath_New>()
external imp$1.FLKeyPath FLKeyPath_New(
  FLSlice specifier,
  ffi.Pointer<ffi.UnsignedInt> outError,
);

@ffi.Native<NativeFLKeyPath_Free>()
external void FLKeyPath_Free(imp$1.FLKeyPath arg0);

@ffi.Native<NativeFLKeyPath_Eval>()
external imp$1.FLValue FLKeyPath_Eval(imp$1.FLKeyPath arg0, imp$1.FLValue root);

@ffi.Native<NativeFLKeyPath_EvalOnce>()
external imp$1.FLValue FLKeyPath_EvalOnce(
  FLSlice specifier,
  imp$1.FLValue root,
  ffi.Pointer<ffi.UnsignedInt> outError,
);
...
external imp$1.FLStringResult FLKeyPath_ToString(imp$1.FLKeyPath path);

@ffi.Native<NativeFLKeyPath_Equals>()
external bool FLKeyPath_Equals(imp$1.FLKeyPath path1, imp$1.FLKeyPath path2);

@ffi.Native<NativeFLKeyPath_GetCount>()
external int FLKeyPath_GetCount(imp$1.FLKeyPath arg0);

@ffi.Native<NativeFLKeyPath_GetElement>()
external bool FLKeyPath_GetElement(
  imp$1.FLKeyPath path,
  int i,
  ffi.Pointer<FLSlice> outDictKey,
  ffi.Pointer<ffi.Int32> outArrayIndex,
);

@ffi.Native<NativeFLKeyPath_NewEmpty>()
external imp$1.FLKeyPath FLKeyPath_NewEmpty();

@ffi.Native<NativeFLKeyPath_AddProperty>()
external void FLKeyPath_AddProperty(
  imp$1.FLKeyPath arg0,
  imp$1.FLString property,
);

@ffi.Native<NativeFLKeyPath_AddIndex>()
external void FLKeyPath_AddIndex(imp$1.FLKeyPath arg0, int index);

@ffi.Native<NativeFLKeyPath_AddComponents>()
external bool FLKeyPath_AddComponents(
  imp$1.FLKeyPath arg0,
  imp$1.FLString specifier,
  ffi.Pointer<ffi.UnsignedInt> outError,
);

@ffi.Native<NativeFLKeyPath_DropComponents>()
external void FLKeyPath_DropComponents(imp$1.FLKeyPath arg0, int n);

@ffi.Native<imp$1.FLValue>()
external imp$1.FLValue kFLNullValue;

@ffi.Native<imp$1.FLValue>()
external imp$1.FLValue kFLUndefinedValue;

@ffi.Native<NativeFLValue_GetType>()
external int FLValue_GetType(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_IsInteger>()
external bool FLValue_IsInteger(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_IsUnsigned>()
external bool FLValue_IsUnsigned(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_IsDouble>()
external bool FLValue_IsDouble(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_AsBool>()
external bool FLValue_AsBool(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_AsInt>()
external int FLValue_AsInt(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_AsUnsigned>()
external int FLValue_AsUnsigned(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_AsFloat>()
external double FLValue_AsFloat(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_AsDouble>()
external double FLValue_AsDouble(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_AsString>()
external imp$1.FLString FLValue_AsString(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_AsTimestamp>()
external imp$1.DartFLTimestamp FLValue_AsTimestamp(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_AsData>()
external FLSlice FLValue_AsData(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_AsArray>()
external imp$1.FLArray FLValue_AsArray(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_AsDict>()
external imp$1.FLDict FLValue_AsDict(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_ToString>()
external imp$1.FLStringResult FLValue_ToString(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_IsEqual>()
external bool FLValue_IsEqual(imp$1.FLValue v1, imp$1.FLValue v2);

@ffi.Native<NativeFLValue_IsMutable>()
external bool FLValue_IsMutable(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_Retain>()
external imp$1.FLValue FLValue_Retain(imp$1.FLValue arg0);

@ffi.Native<NativeFLValue_Release>()
external void FLValue_Release(imp$1.FLValue arg0);

@ffi.Native<NativeFLArray_MutableCopy>()
external imp$1.FLMutableArray FLArray_MutableCopy(imp$1.FLArray arg0, int arg1);

@ffi.Native<NativeFLMutableArray_New>()
external imp$1.FLMutableArray FLMutableArray_New();

@ffi.Native<NativeFLMutableArray_GetSource>()
external imp$1.FLArray FLMutableArray_GetSource(imp$1.FLMutableArray arg0);

@ffi.Native<NativeFLMutableArray_IsChanged>()
external bool FLMutableArray_IsChanged(imp$1.FLMutableArray arg0);

@ffi.Native<NativeFLMutableArray_SetChanged>()
external void FLMutableArray_SetChanged(
  imp$1.FLMutableArray arg0,
  bool changed,
);

@ffi.Native<NativeFLMutableArray_Insert>()
external void FLMutableArray_Insert(
  imp$1.FLMutableArray array,
  int firstIndex,
  int count,
);
...
external void FLMutableArray_Resize(imp$1.FLMutableArray array, int size);

@ffi.Native<NativeFLMutableArray_GetMutableArray>()
external imp$1.FLMutableArray FLMutableArray_GetMutableArray(
  imp$1.FLMutableArray arg0,
  int index,
);

@ffi.Native<NativeFLMutableArray_GetMutableDict>()
external imp$1.FLMutableDict FLMutableArray_GetMutableDict(
  imp$1.FLMutableArray arg0,
  int index,
);

@ffi.Native<NativeFLDict_MutableCopy>()
external imp$1.FLMutableDict FLDict_MutableCopy(imp$1.FLDict source, int arg1);

@ffi.Native<NativeFLMutableDict_New>()
external imp$1.FLMutableDict FLMutableDict_New();

@ffi.Native<NativeFLMutableDict_GetSource>()
external imp$1.FLDict FLMutableDict_GetSource(imp$1.FLMutableDict arg0);

@ffi.Native<NativeFLMutableDict_IsChanged>()
external bool FLMutableDict_IsChanged(imp$1.FLMutableDict arg0);

@ffi.Native<NativeFLMutableDict_SetChanged>()
external void FLMutableDict_SetChanged(imp$1.FLMutableDict arg0, bool arg1);

@ffi.Native<NativeFLMutableDict_Remove>()
external void FLMutableDict_Remove(
  imp$1.FLMutableDict arg0,
  imp$1.FLString key,
);

@ffi.Native<NativeFLMutableDict_RemoveAll>()
external void FLMutableDict_RemoveAll(imp$1.FLMutableDict arg0);

@ffi.Native<NativeFLMutableDict_GetMutableArray>()
external imp$1.FLMutableArray FLMutableDict_GetMutableArray(
  imp$1.FLMutableDict arg0,
  imp$1.FLString key,
);

@ffi.Native<NativeFLMutableDict_GetMutableDict>()
external imp$1.FLMutableDict FLMutableDict_GetMutableDict(
  imp$1.FLMutableDict arg0,
  imp$1.FLString key,
);

@ffi.Native<NativeFLValue_NewString>()
external imp$1.FLValue FLValue_NewString(imp$1.FLString arg0);

@ffi.Native<NativeFLValue_NewData>()
external imp$1.FLValue FLValue_NewData(FLSlice arg0);

@ffi.Native<NativeFLMutableArray_Set>()
external imp$1.FLSlot FLMutableArray_Set(imp$1.FLMutableArray arg0, int index);

@ffi.Native<NativeFLMutableArray_Append>()
external imp$1.FLSlot FLMutableArray_Append(imp$1.FLMutableArray arg0);

@ffi.Native<NativeFLMutableDict_Set>()
external imp$1.FLSlot FLMutableDict_Set(
  imp$1.FLMutableDict arg0,
  imp$1.FLString key,
);

@ffi.Native<NativeFLSlot_SetNull>()
external void FLSlot_SetNull(imp$1.FLSlot arg0);

@ffi.Native<NativeFLSlot_SetBool>()
external void FLSlot_SetBool(imp$1.FLSlot arg0, bool arg1);

@ffi.Native<NativeFLSlot_SetInt>()
external void FLSlot_SetInt(imp$1.FLSlot arg0, int arg1);

@ffi.Native<NativeFLSlot_SetUInt>()
external void FLSlot_SetUInt(imp$1.FLSlot arg0, int arg1);

@ffi.Native<NativeFLSlot_SetFloat>()
external void FLSlot_SetFloat(imp$1.FLSlot arg0, double arg1);

@ffi.Native<NativeFLSlot_SetDouble>()
external void FLSlot_SetDouble(imp$1.FLSlot arg0, double arg1);

@ffi.Native<NativeFLSlot_SetString>()
external void FLSlot_SetString(imp$1.FLSlot arg0, imp$1.FLString arg1);

@ffi.Native<NativeFLSlot_SetData>()
external void FLSlot_SetData(imp$1.FLSlot arg0, FLSlice arg1);

@ffi.Native<NativeFLSlot_SetValue>()
external void FLSlot_SetValue(imp$1.FLSlot arg0, imp$1.FLValue arg1);

@ffi.Native<NativeFLValue_NewWithFormat>()
external imp$1.FLValue FLValue_NewWithFormat(ffi.Pointer<ffi.Char> format);

@ffi.Native<NativeFLValue_NewWithFormatV>()
external imp$1.FLValue FLValue_NewWithFormatV(
  ffi.Pointer<ffi.Char> format,
  imp$1.va_list$1 args,
);

@ffi.Native<NativeFLMutableArray_UpdateWithFormat>()
external void FLMutableArray_UpdateWithFormat(
  imp$1.FLMutableArray arg0,
  ffi.Pointer<ffi.Char> format,
);

@ffi.Native<NativeFLMutableDict_UpdateWithFormat>()
external void FLMutableDict_UpdateWithFormat(
  imp$1.FLMutableDict arg0,
  ffi.Pointer<ffi.Char> format,
);

@ffi.Native<NativeFLValue_UpdateWithFormatV>()
...
external FLSliceResult FLCreateJSONDelta(imp$1.FLValue old, imp$1.FLValue nuu);

@ffi.Native<NativeFLEncodeJSONDelta>()
external bool FLEncodeJSONDelta(
  imp$1.FLValue old,
  imp$1.FLValue nuu,
  imp$1.FLEncoder jsonEncoder,
);
...
external imp$1.FLSharedKeys FLSharedKeys_New();

@ffi.Native<NativeFLSharedKeys_NewWithRead>()
external imp$1.FLSharedKeys FLSharedKeys_NewWithRead(
  imp$1.FLSharedKeysReadCallback arg0,
  ffi.Pointer<ffi.Void> context,
);

@ffi.Native<NativeFLSharedKeys_GetStateData>()
external FLSliceResult FLSharedKeys_GetStateData(imp$1.FLSharedKeys arg0);

@ffi.Native<NativeFLSharedKeys_LoadStateData>()
external bool FLSharedKeys_LoadStateData(imp$1.FLSharedKeys arg0, FLSlice arg1);

@ffi.Native<NativeFLSharedKeys_WriteState>()
external void FLSharedKeys_WriteState(
  imp$1.FLSharedKeys arg0,
  imp$1.FLEncoder arg1,
);
...
external imp$1.FLString FLSharedKeys_Decode(imp$1.FLSharedKeys arg0, int key);

@ffi.Native<NativeFLSharedKeys_Count>()
external int FLSharedKeys_Count(imp$1.FLSharedKeys arg0);

@ffi.Native<NativeFLSharedKeys_RevertToCount>()
external void FLSharedKeys_RevertToCount(imp$1.FLSharedKeys arg0, int oldCount);

@ffi.Native<NativeFLSharedKeys_DisableCaching>()
external void FLSharedKeys_DisableCaching(imp$1.FLSharedKeys arg0);

@ffi.Native<NativeFLSharedKeys_Retain>()
external imp$1.FLSharedKeys FLSharedKeys_Retain(imp$1.FLSharedKeys arg0);

@ffi.Native<NativeFLSharedKeys_Release>()
external void FLSharedKeys_Release(imp$1.FLSharedKeys arg0);

@ffi.Native<NativeFLSharedKeyScope_WithRange>()
external imp$1.FLSharedKeyScope FLSharedKeyScope_WithRange(
  FLSlice range,
  imp$1.FLSharedKeys arg1,
);

@ffi.Native<NativeFLSharedKeyScope_Free>()
external void FLSharedKeyScope_Free(imp$1.FLSharedKeyScope arg0);

@ffi.Native<NativeFLValue_FromData>()
external imp$1.FLValue FLValue_FromData(FLSlice data, int trust);

@ffi.Native<NativeFLJSON5_ToJSON>()
external imp$1.FLStringResult FLJSON5_ToJSON(
  imp$1.FLString json5,
  ffi.Pointer<imp$1.FLStringResult> outErrorMessage,
...
external FLSlice FLEncoder_GetBase(imp$1.FLEncoder arg0);

@ffi.Native<NativeFLEncoder_SuppressTrailer>()
external void FLEncoder_SuppressTrailer(imp$1.FLEncoder arg0);

@ffi.Native<NativeFLEncoder_GetNextWritePos>()
external int FLEncoder_GetNextWritePos(imp$1.FLEncoder arg0);

@ffi.Native<NativeFLEncoder_LastValueWritten>()
external int FLEncoder_LastValueWritten(imp$1.FLEncoder arg0);
...
external FLSliceResult FLEncoder_Snip(imp$1.FLEncoder arg0);

@ffi.Native<NativeFLEncoder_FinishItem>()
external int FLEncoder_FinishItem(imp$1.FLEncoder arg0);

@ffi.Native<NativeFLJSONEncoder_NextDocument>()
external void FLJSONEncoder_NextDocument(imp$1.FLEncoder arg0);

@ffi.Native<NativeFLDump>()
external ffi.Pointer<ffi.Char> FLDump(imp$1.FLValue arg0);

@ffi.Native<NativeFLDumpData>()
external ffi.Pointer<ffi.Char> FLDumpData(FLSlice data);

@ffi.Native<NativeFLData_Dump>()
external imp$1.FLStringResult FLData_Dump(FLSlice data);
...
typedef DartCBLError_Message =
    FLSliceResult Function(ffi.Pointer<CBLError> outError);
typedef NativeCBL_Now = imp$1.CBLTimestamp Function();
typedef DartCBL_Now = imp$1.DartCBLTimestamp Function();
typedef CBLRefCounted = imp$1.CBLRefCounted;
...
typedef NativeFLDict_IsBlob = ffi.Bool Function(imp$1.FLDict arg0);
typedef DartFLDict_IsBlob = bool Function(imp$1.FLDict arg0);
typedef NativeFLDict_GetBlob =
    ffi.Pointer<CBLBlob> Function(imp$1.FLDict blobDict);
typedef DartFLDict_GetBlob =
    ffi.Pointer<CBLBlob> Function(imp$1.FLDict blobDict);
...
typedef NativeCBLBlob_ContentType =
    imp$1.FLString Function(ffi.Pointer<CBLBlob> arg0);
typedef DartCBLBlob_ContentType =
    imp$1.FLString Function(ffi.Pointer<CBLBlob> arg0);
typedef NativeCBLBlob_Digest =
    imp$1.FLString Function(ffi.Pointer<CBLBlob> arg0);
typedef DartCBLBlob_Digest = imp$1.FLString Function(ffi.Pointer<CBLBlob> arg0);
typedef NativeCBLBlob_Properties =
    imp$1.FLDict Function(ffi.Pointer<CBLBlob> arg0);
typedef DartCBLBlob_Properties =
    imp$1.FLDict Function(ffi.Pointer<CBLBlob> arg0);
typedef NativeCBLBlob_CreateJSON =
    imp$1.FLStringResult Function(ffi.Pointer<CBLBlob> blob);
...
typedef NativeCBLBlob_CreateWithData =
    ffi.Pointer<CBLBlob> Function(imp$1.FLString contentType, FLSlice contents);
...
typedef NativeFLSlot_SetBlob =
    ffi.Void Function(imp$1.FLSlot slot, ffi.Pointer<CBLBlob> blob);
typedef DartFLSlot_SetBlob =
    void Function(imp$1.FLSlot slot, ffi.Pointer<CBLBlob> blob);
...
typedef NativeCBLDocument_CreateWithID =
    ffi.Pointer<CBLDocument> Function(imp$1.FLString docID);
...
typedef DartCBLDocument_MutableCopy =
    ffi.Pointer<CBLDocument> Function(ffi.Pointer<CBLDocument> original);
typedef NativeCBLDocument_ID =
    imp$1.FLString Function(ffi.Pointer<CBLDocument> arg0);
typedef DartCBLDocument_ID =
    imp$1.FLString Function(ffi.Pointer<CBLDocument> arg0);
...
typedef DartCBLDocument_Timestamp = int Function(ffi.Pointer<CBLDocument> arg0);
...
typedef NativeCBLDocument_Properties =
    imp$1.FLDict Function(ffi.Pointer<CBLDocument> arg0);
typedef DartCBLDocument_Properties =
    imp$1.FLDict Function(ffi.Pointer<CBLDocument> arg0);
typedef NativeCBLDocument_MutableProperties =
    imp$1.FLMutableDict Function(ffi.Pointer<CBLDocument> arg0);
...
typedef CBLValueIndexConfiguration = imp$1.CBLValueIndexConfiguration;
typedef CBLFullTextIndexConfiguration = imp$1.CBLFullTextIndexConfiguration;
typedef CBLArrayIndexConfiguration = imp$1.CBLArrayIndexConfiguration;
typedef CBLVectorEncoding = imp$1.CBLVectorEncoding;
...
typedef NativeCBLVectorEncoding_CreateScalarQuantizer =
    ffi.Pointer<CBLVectorEncoding> Function(imp$1.CBLScalarQuantizerType type);
...
typedef CBLVectorIndexConfiguration = imp$1.CBLVectorIndexConfiguration;
...
typedef NativeCBLCollection_Name =
    imp$1.FLString Function(ffi.Pointer<CBLCollection> collection);
...
typedef NativeCBLCollection_SaveDocumentWithConcurrencyControl =
    ffi.Bool Function(
      ffi.Pointer<CBLCollection> collection,
      ffi.Pointer<CBLDocument> doc,
      imp$1.CBLConcurrencyControl concurrency,
      ffi.Pointer<CBLError> outError,
    );
...
typedef CBLCollectionChange = imp$1.CBLCollectionChange;
...
typedef CBLDocumentChange = imp$1.CBLDocumentChange;
...
typedef NativeCBL_EnableVectorSearch =
    ffi.Bool Function(imp$1.FLString path, ffi.Pointer<CBLError> outError);
typedef DartCBL_EnableVectorSearch =
    bool Function(imp$1.FLString path, ffi.Pointer<CBLError> outError);
typedef CBLEncryptionKey = imp$1.CBLEncryptionKey;
typedef CBLDatabaseConfiguration = imp$1.CBLDatabaseConfiguration;
...
typedef DartCBLEncryptionKey_FromPassword =
    bool Function(ffi.Pointer<CBLEncryptionKey> key, imp$1.FLString password);
...
typedef NativeCBL_DatabaseExists =
    ffi.Bool Function(imp$1.FLString name, imp$1.FLString inDirectory);
typedef DartCBL_DatabaseExists =
    bool Function(imp$1.FLString name, imp$1.FLString inDirectory);
...
typedef NativeCBLDatabase_Name =
    imp$1.FLString Function(ffi.Pointer<CBLDatabase> arg0);
typedef DartCBLDatabase_Name =
    imp$1.FLString Function(ffi.Pointer<CBLDatabase> arg0);
typedef NativeCBLDatabase_Path =
    imp$1.FLStringResult Function(ffi.Pointer<CBLDatabase> arg0);
...
typedef NativeCBLTLSIdentity_Expiration =
    imp$1.CBLTimestamp Function(ffi.Pointer<CBLTLSIdentity> identity);
typedef DartCBLTLSIdentity_Expiration =
    imp$1.DartCBLTimestamp Function(ffi.Pointer<CBLTLSIdentity> identity);
...
typedef NativeCBLTLSIdentity_DeleteIdentityWithLabel =
    ffi.Bool Function(imp$1.FLString label, ffi.Pointer<CBLError> outError);
typedef DartCBLTLSIdentity_DeleteIdentityWithLabel =
    bool Function(imp$1.FLString label, ffi.Pointer<CBLError> outError);
...
typedef CBLCollectionConfiguration = imp$1.CBLCollectionConfiguration;
typedef CBLReplicatorConfiguration = imp$1.CBLReplicatorConfiguration;
...
typedef CBLReplicatorProgress = imp$1.CBLReplicatorProgress;
typedef CBLReplicatorStatus = imp$1.CBLReplicatorStatus;
...
typedef CBLReplicatedDocument = imp$1.CBLReplicatedDocument;
...
typedef NativeCBLEncryptable_CreateWithString =
    ffi.Pointer<CBLEncryptable> Function(imp$1.FLString value);
typedef DartCBLEncryptable_CreateWithString =
    ffi.Pointer<CBLEncryptable> Function(imp$1.FLString value);
typedef NativeCBLEncryptable_CreateWithValue =
    ffi.Pointer<CBLEncryptable> Function(imp$1.FLValue value);
typedef DartCBLEncryptable_CreateWithValue =
    ffi.Pointer<CBLEncryptable> Function(imp$1.FLValue value);
typedef NativeCBLEncryptable_CreateWithArray =
    ffi.Pointer<CBLEncryptable> Function(imp$1.FLArray value);
typedef DartCBLEncryptable_CreateWithArray =
    ffi.Pointer<CBLEncryptable> Function(imp$1.FLArray value);
typedef NativeCBLEncryptable_CreateWithDict =
    ffi.Pointer<CBLEncryptable> Function(imp$1.FLDict value);
typedef DartCBLEncryptable_CreateWithDict =
    ffi.Pointer<CBLEncryptable> Function(imp$1.FLDict value);
typedef NativeCBLEncryptable_Value =
    imp$1.FLValue Function(ffi.Pointer<CBLEncryptable> encryptable);
typedef DartCBLEncryptable_Value =
    imp$1.FLValue Function(ffi.Pointer<CBLEncryptable> encryptable);
typedef NativeCBLEncryptable_Properties =
    imp$1.FLDict Function(ffi.Pointer<CBLEncryptable> encryptable);
typedef DartCBLEncryptable_Properties =
    imp$1.FLDict Function(ffi.Pointer<CBLEncryptable> encryptable);
typedef NativeFLDict_IsEncryptableValue = ffi.Bool Function(imp$1.FLDict arg0);
typedef DartFLDict_IsEncryptableValue = bool Function(imp$1.FLDict arg0);
typedef NativeFLDict_GetEncryptableValue =
    ffi.Pointer<CBLEncryptable> Function(imp$1.FLDict encryptableDict);
...
typedef DartFLSlot_SetEncryptableValue =
    void Function(imp$1.FLSlot slot, ffi.Pointer<CBLEncryptable> encryptable);
typedef CBLConsoleLogSink = imp$1.CBLConsoleLogSink;
typedef CBLCustomLogSink = imp$1.CBLCustomLogSink;
...
typedef CBLPredictiveModel = imp$1.CBLPredictiveModel;
typedef NativeCBL_RegisterPredictiveModel =
    ffi.Void Function(imp$1.FLString name, CBLPredictiveModel model);
typedef DartCBL_RegisterPredictiveModel =
    void Function(imp$1.FLString name, CBLPredictiveModel model);
typedef NativeCBL_UnregisterPredictiveModel =
    ffi.Void Function(imp$1.FLString name);
typedef DartCBL_UnregisterPredictiveModel = void Function(imp$1.FLString name);
...
typedef NativeCBLQuery_SetParameters =
    ffi.Void Function(ffi.Pointer<CBLQuery> query, imp$1.FLDict parameters);
typedef DartCBLQuery_SetParameters =
    void Function(ffi.Pointer<CBLQuery> query, imp$1.FLDict parameters);
typedef NativeCBLQuery_Parameters =
    imp$1.FLDict Function(ffi.Pointer<CBLQuery> query);
typedef DartCBLQuery_Parameters =
    imp$1.FLDict Function(ffi.Pointer<CBLQuery> query);
...
typedef DartCBLResultSet_ValueAtIndex =
    imp$1.FLValue Function(ffi.Pointer<CBLResultSet> arg0, int index);
typedef NativeCBLResultSet_ValueForKey =
    imp$1.FLValue Function(ffi.Pointer<CBLResultSet> arg0, imp$1.FLString key);
typedef DartCBLResultSet_ValueForKey =
    imp$1.FLValue Function(ffi.Pointer<CBLResultSet> arg0, imp$1.FLString key);
typedef NativeCBLResultSet_ResultArray =
    imp$1.FLArray Function(ffi.Pointer<CBLResultSet> arg0);
typedef DartCBLResultSet_ResultArray =
    imp$1.FLArray Function(ffi.Pointer<CBLResultSet> arg0);
typedef NativeCBLResultSet_ResultDict =
    imp$1.FLDict Function(ffi.Pointer<CBLResultSet> arg0);
...
typedef NativeCBLQueryIndex_Name =
    imp$1.FLString Function(ffi.Pointer<CBLQueryIndex> index);
...
typedef DartCBLIndexUpdater_Value =
    imp$1.FLValue Function(ffi.Pointer<CBLIndexUpdater> updater, int index);
...
typedef NativeCBLScope_Name =
    imp$1.FLString Function(ffi.Pointer<CBLScope> scope);
typedef DartCBLScope_Name =
    imp$1.FLString Function(ffi.Pointer<CBLScope> scope);
...
typedef NativeFLTimestamp_Now = imp$1.FLTimestamp Function();
typedef DartFLTimestamp_Now = imp$1.DartFLTimestamp Function();
typedef NativeFLTimestamp_ToString =
    imp$1.FLStringResult Function(imp$1.FLTimestamp timestamp, ffi.Bool asUTC);
typedef DartFLTimestamp_ToString =
    imp$1.FLStringResult Function(imp$1.DartFLTimestamp timestamp, bool asUTC);
typedef NativeFLTimestamp_FromString =
    imp$1.FLTimestamp Function(imp$1.FLString str);
typedef DartFLTimestamp_FromString =
    imp$1.DartFLTimestamp Function(imp$1.FLString str);
typedef NativeFLArray_Count = ffi.Uint32 Function(imp$1.FLArray arg0);
typedef DartFLArray_Count = int Function(imp$1.FLArray arg0);
typedef NativeFLArray_IsEmpty = ffi.Bool Function(imp$1.FLArray arg0);
typedef DartFLArray_IsEmpty = bool Function(imp$1.FLArray arg0);
typedef NativeFLArray_AsMutable =
    imp$1.FLMutableArray Function(imp$1.FLArray arg0);
typedef DartFLArray_AsMutable =
    imp$1.FLMutableArray Function(imp$1.FLArray arg0);
typedef NativeFLArray_Get =
    imp$1.FLValue Function(imp$1.FLArray arg0, ffi.Uint32 index);
typedef DartFLArray_Get = imp$1.FLValue Function(imp$1.FLArray arg0, int index);
typedef FLArrayIterator = imp$1.FLArrayIterator;
typedef NativeFLArrayIterator_Begin =
    ffi.Void Function(imp$1.FLArray arg0, ffi.Pointer<FLArrayIterator> arg1);
typedef DartFLArrayIterator_Begin =
    void Function(imp$1.FLArray arg0, ffi.Pointer<FLArrayIterator> arg1);
typedef NativeFLArrayIterator_GetValue =
    imp$1.FLValue Function(ffi.Pointer<FLArrayIterator> arg0);
...
typedef DartFLArrayIterator_GetValueAt =
    imp$1.FLValue Function(ffi.Pointer<FLArrayIterator> arg0, int offset);
...
typedef NativeFLDict_Count = ffi.Uint32 Function(imp$1.FLDict arg0);
typedef DartFLDict_Count = int Function(imp$1.FLDict arg0);
typedef NativeFLDict_IsEmpty = ffi.Bool Function(imp$1.FLDict arg0);
typedef DartFLDict_IsEmpty = bool Function(imp$1.FLDict arg0);
typedef NativeFLDict_AsMutable =
    imp$1.FLMutableDict Function(imp$1.FLDict arg0);
typedef DartFLDict_AsMutable = imp$1.FLMutableDict Function(imp$1.FLDict arg0);
typedef NativeFLDict_Get =
    imp$1.FLValue Function(imp$1.FLDict arg0, FLSlice keyString);
typedef DartFLDict_Get =
    imp$1.FLValue Function(imp$1.FLDict arg0, FLSlice keyString);
typedef FLDictIterator = imp$1.FLDictIterator;
typedef NativeFLDictIterator_Begin =
    ffi.Void Function(imp$1.FLDict arg0, ffi.Pointer<FLDictIterator> arg1);
typedef DartFLDictIterator_Begin =
    void Function(imp$1.FLDict arg0, ffi.Pointer<FLDictIterator> arg1);
typedef NativeFLDictIterator_GetKey =
    imp$1.FLValue Function(ffi.Pointer<FLDictIterator> arg0);
typedef DartFLDictIterator_GetKey =
    imp$1.FLValue Function(ffi.Pointer<FLDictIterator> arg0);
typedef NativeFLDictIterator_GetKeyString =
    imp$1.FLString Function(ffi.Pointer<FLDictIterator> arg0);
...
typedef NativeFLDictKey_GetString =
    imp$1.FLString Function(ffi.Pointer<FLDictKey> arg0);
typedef DartFLDictKey_GetString =
    imp$1.FLString Function(ffi.Pointer<FLDictKey> arg0);
typedef NativeFLDict_GetWithKey =
    imp$1.FLValue Function(imp$1.FLDict arg0, ffi.Pointer<FLDictKey> arg1);
typedef DartFLDict_GetWithKey =
    imp$1.FLValue Function(imp$1.FLDict arg0, ffi.Pointer<FLDictKey> arg1);
typedef NativeFLDeepIterator_New =
    imp$1.FLDeepIterator Function(imp$1.FLValue arg0);
typedef DartFLDeepIterator_New =
    imp$1.FLDeepIterator Function(imp$1.FLValue arg0);
typedef NativeFLDeepIterator_Free =
    ffi.Void Function(imp$1.FLDeepIterator arg0);
typedef DartFLDeepIterator_Free = void Function(imp$1.FLDeepIterator arg0);
typedef NativeFLDeepIterator_GetValue =
    imp$1.FLValue Function(imp$1.FLDeepIterator arg0);
typedef DartFLDeepIterator_GetValue =
    imp$1.FLValue Function(imp$1.FLDeepIterator arg0);
typedef NativeFLDeepIterator_GetParent =
    imp$1.FLValue Function(imp$1.FLDeepIterator arg0);
typedef DartFLDeepIterator_GetParent =
    imp$1.FLValue Function(imp$1.FLDeepIterator arg0);
typedef NativeFLDeepIterator_GetKey =
    FLSlice Function(imp$1.FLDeepIterator arg0);
typedef DartFLDeepIterator_GetKey = FLSlice Function(imp$1.FLDeepIterator arg0);
typedef NativeFLDeepIterator_GetIndex =
    ffi.Uint32 Function(imp$1.FLDeepIterator arg0);
typedef DartFLDeepIterator_GetIndex = int Function(imp$1.FLDeepIterator arg0);
typedef NativeFLDeepIterator_GetDepth =
    ffi.Size Function(imp$1.FLDeepIterator arg0);
typedef DartFLDeepIterator_GetDepth = int Function(imp$1.FLDeepIterator arg0);
typedef NativeFLDeepIterator_SkipChildren =
    ffi.Void Function(imp$1.FLDeepIterator arg0);
typedef DartFLDeepIterator_SkipChildren =
    void Function(imp$1.FLDeepIterator arg0);
typedef NativeFLDeepIterator_Next =
    ffi.Bool Function(imp$1.FLDeepIterator arg0);
typedef DartFLDeepIterator_Next = bool Function(imp$1.FLDeepIterator arg0);
typedef FLPathComponent = imp$1.FLPathComponent;
...
typedef NativeFLDeepIterator_GetPathString =
    FLSliceResult Function(imp$1.FLDeepIterator arg0);
...
typedef NativeFLDoc_Release = ffi.Void Function(imp$1.FLDoc arg0);
typedef DartFLDoc_Release = void Function(imp$1.FLDoc arg0);
typedef NativeFLDoc_Retain = imp$1.FLDoc Function(imp$1.FLDoc arg0);
typedef DartFLDoc_Retain = imp$1.FLDoc Function(imp$1.FLDoc arg0);
typedef NativeFLDoc_GetData = FLSlice Function(imp$1.FLDoc doc);
typedef DartFLDoc_GetData = FLSlice Function(imp$1.FLDoc doc);
typedef NativeFLDoc_GetAllocedData = FLSliceResult Function(imp$1.FLDoc arg0);
typedef DartFLDoc_GetAllocedData = FLSliceResult Function(imp$1.FLDoc arg0);
typedef NativeFLDoc_GetRoot = imp$1.FLValue Function(imp$1.FLDoc doc);
typedef DartFLDoc_GetRoot = imp$1.FLValue Function(imp$1.FLDoc doc);
typedef NativeFLDoc_GetSharedKeys =
    imp$1.FLSharedKeys Function(imp$1.FLDoc arg0);
typedef DartFLDoc_GetSharedKeys = imp$1.FLSharedKeys Function(imp$1.FLDoc arg0);
typedef NativeFLValue_FindDoc = imp$1.FLDoc Function(imp$1.FLValue arg0);
typedef DartFLValue_FindDoc = imp$1.FLDoc Function(imp$1.FLValue arg0);
...
typedef NativeFLDoc_GetAssociated =
    ffi.Pointer<ffi.Void> Function(imp$1.FLDoc doc, ffi.Pointer<ffi.Char> type);
...
typedef NativeFLEncoder_New = imp$1.FLEncoder Function();
typedef DartFLEncoder_New = imp$1.FLEncoder Function();
typedef NativeFLEncoder_NewWithOptions =
    imp$1.FLEncoder Function(
      ffi.UnsignedInt format,
      ffi.Size reserveSize,
      ffi.Bool uniqueStrings,
    );
typedef DartFLEncoder_NewWithOptions =
    imp$1.FLEncoder Function(int format, int reserveSize, bool uniqueStrings);
...
typedef DartFLEncoder_NewWritingToFile =
    imp$1.FLEncoder Function(ffi.Pointer<imp$1.FILE> arg0, bool uniqueStrings);
typedef NativeFLEncoder_Free = ffi.Void Function(imp$1.FLEncoder arg0);
typedef DartFLEncoder_Free = void Function(imp$1.FLEncoder arg0);
typedef NativeFLEncoder_SetSharedKeys =
    ffi.Void Function(imp$1.FLEncoder arg0, imp$1.FLSharedKeys arg1);
typedef DartFLEncoder_SetSharedKeys =
    void Function(imp$1.FLEncoder arg0, imp$1.FLSharedKeys arg1);
typedef NativeFLEncoder_SetExtraInfo =
    ffi.Void Function(imp$1.FLEncoder arg0, ffi.Pointer<ffi.Void> info);
typedef DartFLEncoder_SetExtraInfo =
    void Function(imp$1.FLEncoder arg0, ffi.Pointer<ffi.Void> info);
typedef NativeFLEncoder_GetExtraInfo =
    ffi.Pointer<ffi.Void> Function(imp$1.FLEncoder arg0);
typedef DartFLEncoder_GetExtraInfo =
    ffi.Pointer<ffi.Void> Function(imp$1.FLEncoder arg0);
typedef NativeFLEncoder_Reset = ffi.Void Function(imp$1.FLEncoder arg0);
typedef DartFLEncoder_Reset = void Function(imp$1.FLEncoder arg0);
typedef NativeFLEncoder_BytesWritten = ffi.Size Function(imp$1.FLEncoder arg0);
typedef DartFLEncoder_BytesWritten = int Function(imp$1.FLEncoder arg0);
typedef NativeFLEncoder_WriteNull = ffi.Bool Function(imp$1.FLEncoder arg0);
typedef DartFLEncoder_WriteNull = bool Function(imp$1.FLEncoder arg0);
typedef NativeFLEncoder_WriteUndefined =
    ffi.Bool Function(imp$1.FLEncoder arg0);
typedef DartFLEncoder_WriteUndefined = bool Function(imp$1.FLEncoder arg0);
typedef NativeFLEncoder_WriteBool =
    ffi.Bool Function(imp$1.FLEncoder arg0, ffi.Bool arg1);
typedef DartFLEncoder_WriteBool =
    bool Function(imp$1.FLEncoder arg0, bool arg1);
typedef NativeFLEncoder_WriteInt =
    ffi.Bool Function(imp$1.FLEncoder arg0, ffi.Int64 arg1);
typedef DartFLEncoder_WriteInt = bool Function(imp$1.FLEncoder arg0, int arg1);
typedef NativeFLEncoder_WriteUInt =
    ffi.Bool Function(imp$1.FLEncoder arg0, ffi.Uint64 arg1);
typedef DartFLEncoder_WriteUInt = bool Function(imp$1.FLEncoder arg0, int arg1);
typedef NativeFLEncoder_WriteFloat =
    ffi.Bool Function(imp$1.FLEncoder arg0, ffi.Float arg1);
typedef DartFLEncoder_WriteFloat =
    bool Function(imp$1.FLEncoder arg0, double arg1);
typedef NativeFLEncoder_WriteDouble =
    ffi.Bool Function(imp$1.FLEncoder arg0, ffi.Double arg1);
typedef DartFLEncoder_WriteDouble =
    bool Function(imp$1.FLEncoder arg0, double arg1);
typedef NativeFLEncoder_WriteString =
    ffi.Bool Function(imp$1.FLEncoder arg0, imp$1.FLString arg1);
typedef DartFLEncoder_WriteString =
    bool Function(imp$1.FLEncoder arg0, imp$1.FLString arg1);
typedef NativeFLEncoder_WriteDateString =
    ffi.Bool Function(
      imp$1.FLEncoder encoder,
      imp$1.FLTimestamp ts,
      ffi.Bool asUTC,
    );
...
typedef NativeFLEncoder_WriteData =
    ffi.Bool Function(imp$1.FLEncoder arg0, FLSlice arg1);
typedef DartFLEncoder_WriteData =
    bool Function(imp$1.FLEncoder arg0, FLSlice arg1);
typedef NativeFLEncoder_WriteValue =
    ffi.Bool Function(imp$1.FLEncoder arg0, imp$1.FLValue arg1);
typedef DartFLEncoder_WriteValue =
    bool Function(imp$1.FLEncoder arg0, imp$1.FLValue arg1);
typedef NativeFLEncoder_WriteFormatted =
    ffi.Bool Function(imp$1.FLEncoder arg0, ffi.Pointer<ffi.Char> format);
typedef DartFLEncoder_WriteFormatted =
    bool Function(imp$1.FLEncoder arg0, ffi.Pointer<ffi.Char> format);
...
typedef NativeFLEncoder_BeginArray =
    ffi.Bool Function(imp$1.FLEncoder arg0, ffi.Size reserveCount);
typedef DartFLEncoder_BeginArray =
    bool Function(imp$1.FLEncoder arg0, int reserveCount);
typedef NativeFLEncoder_EndArray = ffi.Bool Function(imp$1.FLEncoder arg0);
typedef DartFLEncoder_EndArray = bool Function(imp$1.FLEncoder arg0);
...
typedef NativeFLEncoder_WriteKey =
    ffi.Bool Function(imp$1.FLEncoder arg0, imp$1.FLString arg1);
typedef DartFLEncoder_WriteKey =
    bool Function(imp$1.FLEncoder arg0, imp$1.FLString arg1);
typedef NativeFLEncoder_WriteKeyValue =
    ffi.Bool Function(imp$1.FLEncoder arg0, imp$1.FLValue arg1);
typedef DartFLEncoder_WriteKeyValue =
    bool Function(imp$1.FLEncoder arg0, imp$1.FLValue arg1);
typedef NativeFLEncoder_EndDict = ffi.Bool Function(imp$1.FLEncoder arg0);
typedef DartFLEncoder_EndDict = bool Function(imp$1.FLEncoder arg0);
typedef NativeFLEncoder_WriteRaw =
    ffi.Bool Function(imp$1.FLEncoder arg0, FLSlice arg1);
typedef DartFLEncoder_WriteRaw =
    bool Function(imp$1.FLEncoder arg0, FLSlice arg1);
...
typedef NativeFLEncoder_GetError =
    ffi.UnsignedInt Function(imp$1.FLEncoder arg0);
typedef DartFLEncoder_GetError = int Function(imp$1.FLEncoder arg0);
typedef NativeFLEncoder_GetErrorMessage =
    ffi.Pointer<ffi.Char> Function(imp$1.FLEncoder e);
typedef DartFLEncoder_GetErrorMessage =
    ffi.Pointer<ffi.Char> Function(imp$1.FLEncoder e);
typedef NativeFLValue_ToJSON =
    imp$1.FLStringResult Function(imp$1.FLValue arg0);
typedef DartFLValue_ToJSON = imp$1.FLStringResult Function(imp$1.FLValue arg0);
typedef NativeFLValue_ToJSON5 =
    imp$1.FLStringResult Function(imp$1.FLValue arg0);
typedef DartFLValue_ToJSON5 = imp$1.FLStringResult Function(imp$1.FLValue arg0);
typedef NativeFLValue_ToJSONX =
    imp$1.FLStringResult Function(
      imp$1.FLValue v,
      ffi.Bool json5,
      ffi.Bool canonicalForm,
    );
...
typedef NativeFLDoc_FromJSON =
    imp$1.FLDoc Function(FLSlice json, ffi.Pointer<ffi.UnsignedInt> outError);
...
typedef NativeFLEncoder_ConvertJSON =
    ffi.Bool Function(imp$1.FLEncoder arg0, FLSlice json);
typedef DartFLEncoder_ConvertJSON =
    bool Function(imp$1.FLEncoder arg0, FLSlice json);
typedef NativeFLKeyPath_New =
    imp$1.FLKeyPath Function(
      FLSlice specifier,
      ffi.Pointer<ffi.UnsignedInt> outError,
    );
...
typedef NativeFLKeyPath_Free = ffi.Void Function(imp$1.FLKeyPath arg0);
typedef DartFLKeyPath_Free = void Function(imp$1.FLKeyPath arg0);
typedef NativeFLKeyPath_Eval =
    imp$1.FLValue Function(imp$1.FLKeyPath arg0, imp$1.FLValue root);
typedef DartFLKeyPath_Eval =
    imp$1.FLValue Function(imp$1.FLKeyPath arg0, imp$1.FLValue root);
...
typedef NativeFLKeyPath_ToString =
    imp$1.FLStringResult Function(imp$1.FLKeyPath path);
typedef DartFLKeyPath_ToString =
    imp$1.FLStringResult Function(imp$1.FLKeyPath path);
typedef NativeFLKeyPath_Equals =
    ffi.Bool Function(imp$1.FLKeyPath path1, imp$1.FLKeyPath path2);
typedef DartFLKeyPath_Equals =
    bool Function(imp$1.FLKeyPath path1, imp$1.FLKeyPath path2);
typedef NativeFLKeyPath_GetCount = ffi.Size Function(imp$1.FLKeyPath arg0);
typedef DartFLKeyPath_GetCount = int Function(imp$1.FLKeyPath arg0);
...
typedef NativeFLKeyPath_NewEmpty = imp$1.FLKeyPath Function();
typedef DartFLKeyPath_NewEmpty = imp$1.FLKeyPath Function();
typedef NativeFLKeyPath_AddProperty =
    ffi.Void Function(imp$1.FLKeyPath arg0, imp$1.FLString property);
typedef DartFLKeyPath_AddProperty =
    void Function(imp$1.FLKeyPath arg0, imp$1.FLString property);
typedef NativeFLKeyPath_AddIndex =
    ffi.Void Function(imp$1.FLKeyPath arg0, ffi.Int index);
typedef DartFLKeyPath_AddIndex = void Function(imp$1.FLKeyPath arg0, int index);
...
typedef NativeFLKeyPath_DropComponents =
    ffi.Void Function(imp$1.FLKeyPath arg0, ffi.Size n);
typedef DartFLKeyPath_DropComponents =
    void Function(imp$1.FLKeyPath arg0, int n);
...
typedef NativeFLValue_GetType = ffi.Int Function(imp$1.FLValue arg0);
typedef DartFLValue_GetType = int Function(imp$1.FLValue arg0);
typedef NativeFLValue_IsInteger = ffi.Bool Function(imp$1.FLValue arg0);
typedef DartFLValue_IsInteger = bool Function(imp$1.FLValue arg0);
typedef NativeFLValue_IsUnsigned = ffi.Bool Function(imp$1.FLValue arg0);
typedef DartFLValue_IsUnsigned = bool Function(imp$1.FLValue arg0);
typedef NativeFLValue_IsDouble = ffi.Bool Function(imp$1.FLValue arg0);
typedef DartFLValue_IsDouble = bool Function(imp$1.FLValue arg0);
typedef NativeFLValue_AsBool = ffi.Bool Function(imp$1.FLValue arg0);
typedef DartFLValue_AsBool = bool Function(imp$1.FLValue arg0);
typedef NativeFLValue_AsInt = ffi.Int64 Function(imp$1.FLValue arg0);
typedef DartFLValue_AsInt = int Function(imp$1.FLValue arg0);
typedef NativeFLValue_AsUnsigned = ffi.Uint64 Function(imp$1.FLValue arg0);
typedef DartFLValue_AsUnsigned = int Function(imp$1.FLValue arg0);
typedef NativeFLValue_AsFloat = ffi.Float Function(imp$1.FLValue arg0);
typedef DartFLValue_AsFloat = double Function(imp$1.FLValue arg0);
typedef NativeFLValue_AsDouble = ffi.Double Function(imp$1.FLValue arg0);
typedef DartFLValue_AsDouble = double Function(imp$1.FLValue arg0);
typedef NativeFLValue_AsString = imp$1.FLString Function(imp$1.FLValue arg0);
typedef DartFLValue_AsString = imp$1.FLString Function(imp$1.FLValue arg0);
typedef NativeFLValue_AsTimestamp =
    imp$1.FLTimestamp Function(imp$1.FLValue arg0);
typedef DartFLValue_AsTimestamp =
    imp$1.DartFLTimestamp Function(imp$1.FLValue arg0);
typedef NativeFLValue_AsData = FLSlice Function(imp$1.FLValue arg0);
typedef DartFLValue_AsData = FLSlice Function(imp$1.FLValue arg0);
typedef NativeFLValue_AsArray = imp$1.FLArray Function(imp$1.FLValue arg0);
typedef DartFLValue_AsArray = imp$1.FLArray Function(imp$1.FLValue arg0);
typedef NativeFLValue_AsDict = imp$1.FLDict Function(imp$1.FLValue arg0);
typedef DartFLValue_AsDict = imp$1.FLDict Function(imp$1.FLValue arg0);
typedef NativeFLValue_ToString =
    imp$1.FLStringResult Function(imp$1.FLValue arg0);
typedef DartFLValue_ToString =
    imp$1.FLStringResult Function(imp$1.FLValue arg0);
typedef NativeFLValue_IsEqual =
    ffi.Bool Function(imp$1.FLValue v1, imp$1.FLValue v2);
typedef DartFLValue_IsEqual = bool Function(imp$1.FLValue v1, imp$1.FLValue v2);
typedef NativeFLValue_IsMutable = ffi.Bool Function(imp$1.FLValue arg0);
typedef DartFLValue_IsMutable = bool Function(imp$1.FLValue arg0);
typedef NativeFLValue_Retain = imp$1.FLValue Function(imp$1.FLValue arg0);
typedef DartFLValue_Retain = imp$1.FLValue Function(imp$1.FLValue arg0);
typedef NativeFLValue_Release = ffi.Void Function(imp$1.FLValue arg0);
typedef DartFLValue_Release = void Function(imp$1.FLValue arg0);
...
typedef NativeFLArray_MutableCopy =
    imp$1.FLMutableArray Function(imp$1.FLArray arg0, ffi.UnsignedInt arg1);
typedef DartFLArray_MutableCopy =
    imp$1.FLMutableArray Function(imp$1.FLArray arg0, int arg1);
typedef NativeFLMutableArray_New = imp$1.FLMutableArray Function();
typedef DartFLMutableArray_New = imp$1.FLMutableArray Function();
typedef NativeFLMutableArray_GetSource =
    imp$1.FLArray Function(imp$1.FLMutableArray arg0);
typedef DartFLMutableArray_GetSource =
    imp$1.FLArray Function(imp$1.FLMutableArray arg0);
typedef NativeFLMutableArray_IsChanged =
    ffi.Bool Function(imp$1.FLMutableArray arg0);
typedef DartFLMutableArray_IsChanged = bool Function(imp$1.FLMutableArray arg0);
typedef NativeFLMutableArray_SetChanged =
    ffi.Void Function(imp$1.FLMutableArray arg0, ffi.Bool changed);
typedef DartFLMutableArray_SetChanged =
    void Function(imp$1.FLMutableArray arg0, bool changed);
...
typedef DartFLMutableArray_Insert =
    void Function(imp$1.FLMutableArray array, int firstIndex, int count);
...
typedef NativeFLMutableArray_Resize =
    ffi.Void Function(imp$1.FLMutableArray array, ffi.Uint32 size);
typedef DartFLMutableArray_Resize =
    void Function(imp$1.FLMutableArray array, int size);
typedef NativeFLMutableArray_GetMutableArray =
    imp$1.FLMutableArray Function(imp$1.FLMutableArray arg0, ffi.Uint32 index);
typedef DartFLMutableArray_GetMutableArray =
    imp$1.FLMutableArray Function(imp$1.FLMutableArray arg0, int index);
typedef NativeFLMutableArray_GetMutableDict =
    imp$1.FLMutableDict Function(imp$1.FLMutableArray arg0, ffi.Uint32 index);
typedef DartFLMutableArray_GetMutableDict =
    imp$1.FLMutableDict Function(imp$1.FLMutableArray arg0, int index);
typedef NativeFLDict_MutableCopy =
    imp$1.FLMutableDict Function(imp$1.FLDict source, ffi.UnsignedInt arg1);
typedef DartFLDict_MutableCopy =
    imp$1.FLMutableDict Function(imp$1.FLDict source, int arg1);
typedef NativeFLMutableDict_New = imp$1.FLMutableDict Function();
typedef DartFLMutableDict_New = imp$1.FLMutableDict Function();
typedef NativeFLMutableDict_GetSource =
    imp$1.FLDict Function(imp$1.FLMutableDict arg0);
typedef DartFLMutableDict_GetSource =
    imp$1.FLDict Function(imp$1.FLMutableDict arg0);
typedef NativeFLMutableDict_IsChanged =
    ffi.Bool Function(imp$1.FLMutableDict arg0);
typedef DartFLMutableDict_IsChanged = bool Function(imp$1.FLMutableDict arg0);
typedef NativeFLMutableDict_SetChanged =
    ffi.Void Function(imp$1.FLMutableDict arg0, ffi.Bool arg1);
typedef DartFLMutableDict_SetChanged =
    void Function(imp$1.FLMutableDict arg0, bool arg1);
typedef NativeFLMutableDict_Remove =
    ffi.Void Function(imp$1.FLMutableDict arg0, imp$1.FLString key);
typedef DartFLMutableDict_Remove =
    void Function(imp$1.FLMutableDict arg0, imp$1.FLString key);
typedef NativeFLMutableDict_RemoveAll =
    ffi.Void Function(imp$1.FLMutableDict arg0);
typedef DartFLMutableDict_RemoveAll = void Function(imp$1.FLMutableDict arg0);
typedef NativeFLMutableDict_GetMutableArray =
    imp$1.FLMutableArray Function(imp$1.FLMutableDict arg0, imp$1.FLString key);
typedef DartFLMutableDict_GetMutableArray =
    imp$1.FLMutableArray Function(imp$1.FLMutableDict arg0, imp$1.FLString key);
typedef NativeFLMutableDict_GetMutableDict =
    imp$1.FLMutableDict Function(imp$1.FLMutableDict arg0, imp$1.FLString key);
typedef DartFLMutableDict_GetMutableDict =
    imp$1.FLMutableDict Function(imp$1.FLMutableDict arg0, imp$1.FLString key);
typedef NativeFLValue_NewString = imp$1.FLValue Function(imp$1.FLString arg0);
typedef DartFLValue_NewString = imp$1.FLValue Function(imp$1.FLString arg0);
typedef NativeFLValue_NewData = imp$1.FLValue Function(FLSlice arg0);
typedef DartFLValue_NewData = imp$1.FLValue Function(FLSlice arg0);
typedef NativeFLMutableArray_Set =
    imp$1.FLSlot Function(imp$1.FLMutableArray arg0, ffi.Uint32 index);
typedef DartFLMutableArray_Set =
    imp$1.FLSlot Function(imp$1.FLMutableArray arg0, int index);
typedef NativeFLMutableArray_Append =
    imp$1.FLSlot Function(imp$1.FLMutableArray arg0);
typedef DartFLMutableArray_Append =
    imp$1.FLSlot Function(imp$1.FLMutableArray arg0);
typedef NativeFLMutableDict_Set =
    imp$1.FLSlot Function(imp$1.FLMutableDict arg0, imp$1.FLString key);
typedef DartFLMutableDict_Set =
    imp$1.FLSlot Function(imp$1.FLMutableDict arg0, imp$1.FLString key);
typedef NativeFLSlot_SetNull = ffi.Void Function(imp$1.FLSlot arg0);
typedef DartFLSlot_SetNull = void Function(imp$1.FLSlot arg0);
typedef NativeFLSlot_SetBool =
    ffi.Void Function(imp$1.FLSlot arg0, ffi.Bool arg1);
typedef DartFLSlot_SetBool = void Function(imp$1.FLSlot arg0, bool arg1);
typedef NativeFLSlot_SetInt =
    ffi.Void Function(imp$1.FLSlot arg0, ffi.Int64 arg1);
typedef DartFLSlot_SetInt = void Function(imp$1.FLSlot arg0, int arg1);
typedef NativeFLSlot_SetUInt =
    ffi.Void Function(imp$1.FLSlot arg0, ffi.Uint64 arg1);
typedef DartFLSlot_SetUInt = void Function(imp$1.FLSlot arg0, int arg1);
typedef NativeFLSlot_SetFloat =
    ffi.Void Function(imp$1.FLSlot arg0, ffi.Float arg1);
typedef DartFLSlot_SetFloat = void Function(imp$1.FLSlot arg0, double arg1);
typedef NativeFLSlot_SetDouble =
    ffi.Void Function(imp$1.FLSlot arg0, ffi.Double arg1);
typedef DartFLSlot_SetDouble = void Function(imp$1.FLSlot arg0, double arg1);
typedef NativeFLSlot_SetString =
    ffi.Void Function(imp$1.FLSlot arg0, imp$1.FLString arg1);
typedef DartFLSlot_SetString =
    void Function(imp$1.FLSlot arg0, imp$1.FLString arg1);
typedef NativeFLSlot_SetData =
    ffi.Void Function(imp$1.FLSlot arg0, FLSlice arg1);
typedef DartFLSlot_SetData = void Function(imp$1.FLSlot arg0, FLSlice arg1);
typedef NativeFLSlot_SetValue =
    ffi.Void Function(imp$1.FLSlot arg0, imp$1.FLValue arg1);
typedef DartFLSlot_SetValue =
    void Function(imp$1.FLSlot arg0, imp$1.FLValue arg1);
typedef NativeFLValue_NewWithFormat =
    imp$1.FLValue Function(ffi.Pointer<ffi.Char> format);
typedef DartFLValue_NewWithFormat =
    imp$1.FLValue Function(ffi.Pointer<ffi.Char> format);
typedef NativeFLValue_NewWithFormatV =
    imp$1.FLValue Function(ffi.Pointer<ffi.Char> format, imp$1.va_list$1 args);
typedef DartFLValue_NewWithFormatV =
    imp$1.FLValue Function(ffi.Pointer<ffi.Char> format, imp$1.va_list$1 args);
typedef NativeFLMutableArray_UpdateWithFormat =
    ffi.Void Function(imp$1.FLMutableArray arg0, ffi.Pointer<ffi.Char> format);
typedef DartFLMutableArray_UpdateWithFormat =
    void Function(imp$1.FLMutableArray arg0, ffi.Pointer<ffi.Char> format);
typedef NativeFLMutableDict_UpdateWithFormat =
    ffi.Void Function(imp$1.FLMutableDict arg0, ffi.Pointer<ffi.Char> format);
typedef DartFLMutableDict_UpdateWithFormat =
    void Function(imp$1.FLMutableDict arg0, ffi.Pointer<ffi.Char> format);
...
typedef NativeFLCreateJSONDelta =
    FLSliceResult Function(imp$1.FLValue old, imp$1.FLValue nuu);
...
typedef NativeFLSharedKeys_New = imp$1.FLSharedKeys Function();
typedef DartFLSharedKeys_New = imp$1.FLSharedKeys Function();
typedef NativeFLSharedKeys_NewWithRead =
    imp$1.FLSharedKeys Function(
      imp$1.FLSharedKeysReadCallback arg0,
      ffi.Pointer<ffi.Void> context,
    );
...
typedef NativeFLSharedKeys_GetStateData =
    FLSliceResult Function(imp$1.FLSharedKeys arg0);
typedef DartFLSharedKeys_GetStateData =
    FLSliceResult Function(imp$1.FLSharedKeys arg0);
typedef NativeFLSharedKeys_LoadStateData =
    ffi.Bool Function(imp$1.FLSharedKeys arg0, FLSlice arg1);
typedef DartFLSharedKeys_LoadStateData =
    bool Function(imp$1.FLSharedKeys arg0, FLSlice arg1);
typedef NativeFLSharedKeys_WriteState =
    ffi.Void Function(imp$1.FLSharedKeys arg0, imp$1.FLEncoder arg1);
typedef DartFLSharedKeys_WriteState =
    void Function(imp$1.FLSharedKeys arg0, imp$1.FLEncoder arg1);
typedef NativeFLSharedKeys_LoadState =
    ffi.Bool Function(imp$1.FLSharedKeys arg0, imp$1.FLValue arg1);
typedef DartFLSharedKeys_LoadState =
    bool Function(imp$1.FLSharedKeys arg0, imp$1.FLValue arg1);
...
typedef DartFLSharedKeys_Encode =
    int Function(imp$1.FLSharedKeys arg0, imp$1.FLString arg1, bool add);
typedef NativeFLSharedKeys_Decode =
    imp$1.FLString Function(imp$1.FLSharedKeys arg0, ffi.Int key);
typedef DartFLSharedKeys_Decode =
    imp$1.FLString Function(imp$1.FLSharedKeys arg0, int key);
typedef NativeFLSharedKeys_Count =
    ffi.UnsignedInt Function(imp$1.FLSharedKeys arg0);
typedef DartFLSharedKeys_Count = int Function(imp$1.FLSharedKeys arg0);
typedef NativeFLSharedKeys_RevertToCount =
    ffi.Void Function(imp$1.FLSharedKeys arg0, ffi.UnsignedInt oldCount);
typedef DartFLSharedKeys_RevertToCount =
    void Function(imp$1.FLSharedKeys arg0, int oldCount);
typedef NativeFLSharedKeys_DisableCaching =
    ffi.Void Function(imp$1.FLSharedKeys arg0);
typedef DartFLSharedKeys_DisableCaching =
    void Function(imp$1.FLSharedKeys arg0);
typedef NativeFLSharedKeys_Retain =
    imp$1.FLSharedKeys Function(imp$1.FLSharedKeys arg0);
typedef DartFLSharedKeys_Retain =
    imp$1.FLSharedKeys Function(imp$1.FLSharedKeys arg0);
typedef NativeFLSharedKeys_Release = ffi.Void Function(imp$1.FLSharedKeys arg0);
typedef DartFLSharedKeys_Release = void Function(imp$1.FLSharedKeys arg0);
typedef NativeFLSharedKeyScope_WithRange =
    imp$1.FLSharedKeyScope Function(FLSlice range, imp$1.FLSharedKeys arg1);
typedef DartFLSharedKeyScope_WithRange =
    imp$1.FLSharedKeyScope Function(FLSlice range, imp$1.FLSharedKeys arg1);
typedef NativeFLSharedKeyScope_Free =
    ffi.Void Function(imp$1.FLSharedKeyScope arg0);
typedef DartFLSharedKeyScope_Free = void Function(imp$1.FLSharedKeyScope arg0);
typedef NativeFLValue_FromData =
    imp$1.FLValue Function(FLSlice data, ffi.Int trust);
typedef DartFLValue_FromData = imp$1.FLValue Function(FLSlice data, int trust);
...
typedef NativeFLEncoder_GetBase = FLSlice Function(imp$1.FLEncoder arg0);
typedef DartFLEncoder_GetBase = FLSlice Function(imp$1.FLEncoder arg0);
typedef NativeFLEncoder_SuppressTrailer =
    ffi.Void Function(imp$1.FLEncoder arg0);
typedef DartFLEncoder_SuppressTrailer = void Function(imp$1.FLEncoder arg0);
typedef NativeFLEncoder_GetNextWritePos =
    ffi.Size Function(imp$1.FLEncoder arg0);
typedef DartFLEncoder_GetNextWritePos = int Function(imp$1.FLEncoder arg0);
typedef NativeFLEncoder_LastValueWritten =
    ffi.IntPtr Function(imp$1.FLEncoder arg0);
typedef DartFLEncoder_LastValueWritten = int Function(imp$1.FLEncoder arg0);
typedef NativeFLEncoder_WriteValueAgain =
    ffi.Bool Function(imp$1.FLEncoder arg0, ffi.IntPtr preWrittenValue);
typedef DartFLEncoder_WriteValueAgain =
    bool Function(imp$1.FLEncoder arg0, int preWrittenValue);
typedef NativeFLEncoder_Snip = FLSliceResult Function(imp$1.FLEncoder arg0);
typedef DartFLEncoder_Snip = FLSliceResult Function(imp$1.FLEncoder arg0);
typedef NativeFLEncoder_FinishItem = ffi.Size Function(imp$1.FLEncoder arg0);
typedef DartFLEncoder_FinishItem = int Function(imp$1.FLEncoder arg0);
typedef NativeFLJSONEncoder_NextDocument =
    ffi.Void Function(imp$1.FLEncoder arg0);
typedef DartFLJSONEncoder_NextDocument = void Function(imp$1.FLEncoder arg0);
typedef NativeFLDump = ffi.Pointer<ffi.Char> Function(imp$1.FLValue arg0);
typedef DartFLDump = ffi.Pointer<ffi.Char> Function(imp$1.FLValue arg0);
