...
class cblitedartNative implements cblitedart {
  ...
  void CBLDart_FLSliceResult_RetainByBuf(ffi.Pointer<ffi.Void> buf) =>
      native.CBLDart_FLSliceResult_RetainByBuf(buf);

  @override
  void CBLDart_FLSliceResult_ReleaseByBuf(ffi.Pointer<ffi.Void> buf) =>
      native.CBLDart_FLSliceResult_ReleaseByBuf(buf);
  ...
  @override
  void CBLDart_KnownSharedKeys_Delete(ffi.Pointer<KnownSharedKeys> keys) =>
      native.CBLDart_KnownSharedKeys_Delete(keys);

  @override
  void CBLDart_GetLoadedFLValue(
    imp$1.FLValue value,
    ffi.Pointer<CBLDart_LoadedFLValue> out,
  ) => native.CBLDart_GetLoadedFLValue(value, out);
  ...
  void CBLDart_FLArray_GetLoadedFLValue(
    ...
    int index,
    ffi.Pointer<CBLDart_LoadedFLValue> out,
  ) => native.CBLDart_FLArray_GetLoadedFLValue(array, index, out);
  ...
  void CBLDart_FLDict_GetLoadedFLValue(
    ...
    imp$1.FLString key,
    ffi.Pointer<CBLDart_LoadedFLValue> out,
  ) => native.CBLDart_FLDict_GetLoadedFLValue(dict, key, out);
  ...
  ) => native.CBLDart_FLDictIterator_Delete(iterator);

  @override
  bool CBLDart_FLDictIterator_Next(
    ffi.Pointer<CBLDart_FLDictIterator> iterator,
  ) => native.CBLDart_FLDictIterator_Next(iterator);
  ...
  ffi.Pointer<CBLDart_FLArrayIterator> CBLDart_FLArrayIterator_Begin(
    ...
    ffi.Pointer<CBLDart_LoadedFLValue> valueOut,
    bool deleteOnDone,
  ) => native.CBLDart_FLArrayIterator_Begin(array, valueOut, deleteOnDone);

  @override
  void CBLDart_FLArrayIterator_Delete(
    ffi.Pointer<CBLDart_FLArrayIterator> iterator,
  ) => native.CBLDart_FLArrayIterator_Delete(iterator);

  @override
  bool CBLDart_FLArrayIterator_Next(
    ffi.Pointer<CBLDart_FLArrayIterator> iterator,
  ) => native.CBLDart_FLArrayIterator_Next(iterator);
  ...
  bool CBLDart_FLEncoder_WriteArrayValue(
    ...
    imp$1.FLArray array,
    int index,
  ) => native.CBLDart_FLEncoder_WriteArrayValue(encoder, array, index);
  ...
  int CBLDart_Initialize(
    ...
    ffi.Pointer<CBLError> errorOut,
      ...
      native.CBLDart_Initialize(dartInitializeDlData, cblInitContext, errorOut);
  ...
  CBLDart_AsyncCallback CBLDart_AsyncCallback_New(
    ...
    int sendPort,
    bool debug,
  ) => native.CBLDart_AsyncCallback_New(id, sendPort, debug);

  @override
  void CBLDart_AsyncCallback_Delete(CBLDart_AsyncCallback callback) =>
      native.CBLDart_AsyncCallback_Delete(callback);

  @override
  void CBLDart_AsyncCallback_Close(CBLDart_AsyncCallback callback) =>
      native.CBLDart_AsyncCallback_Close(callback);

  @override
  void CBLDart_AsyncCallback_CallForTest(
    CBLDart_AsyncCallback callback,
    int argument,
  ) => native.CBLDart_AsyncCallback_CallForTest(callback, argument);

  @override
  void CBLDart_Completer_Complete(CBLDart_Completer completer, int result) =>
      native.CBLDart_Completer_Complete(completer, result);

  @override
  int CBLDart_AllocateIsolateId() => native.CBLDart_AllocateIsolateId();

  @override
  void CBLDart_SetCurrentIsolateId(int isolateId) =>
      native.CBLDart_SetCurrentIsolateId(isolateId);
  ...
  bool CBLDart_CBLLog_SetCallback(CBLDart_AsyncCallback callback) =>
      native.CBLDart_CBLLog_SetCallback(callback);

  @override
  void CBLDart_CBLLog_SetCallbackLevel(imp$1.DartCBLLogLevel level) =>
  ...
  bool CBLDart_CBLLog_SetSentryBreadcrumbs(bool enabled) =>
      native.CBLDart_CBLLog_SetSentryBreadcrumbs(enabled);
  ...
  ) => native.CBLDart_CBL_CopyDatabase(fromPath, toName, config, outError);
  ...
  ffi.Pointer<CBLDatabase> CBLDart_CBLDatabase_Open(
    ...
    ffi.Pointer<CBLDart_CBLDatabaseConfiguration> config,
    ffi.Pointer<CBLError> errorOut,
  ) => native.CBLDart_CBLDatabase_Open(name, config, errorOut);

  @override
  void CBLDart_CBLDatabase_Release(ffi.Pointer<CBLDatabase> database) =>
      native.CBLDart_CBLDatabase_Release(database);
  ...
  bool CBLDart_CBLDatabase_Close(
    ...
    bool andDelete,
    ffi.Pointer<CBLError> errorOut,
  ) => native.CBLDart_CBLDatabase_Close(database, andDelete, errorOut);
  ...
  void CBLDart_CBLCollection_AddChangeListener(
    ...
    ffi.Pointer<CBLCollection> collection,
    CBLDart_AsyncCallback listener,
  ) => native.CBLDart_CBLCollection_AddChangeListener(db, collection, listener);
  ...
  ffi.Pointer<CBLListenerToken> CBLDart_CBLQuery_AddChangeListener(
    ...
    CBLDart_AsyncCallback listener,
  ) => native.CBLDart_CBLQuery_AddChangeListener(db, query, listener);
  ...
  void CBLDart_PredictiveModel_Delete(CBLDart_PredictiveModel model) =>
      native.CBLDart_PredictiveModel_Delete(model);
  ...
  FLSliceResult CBLDart_CBLBlobReader_Read(
    ...
    int bufferSize,
    ffi.Pointer<CBLError> outError,
  ) => native.CBLDart_CBLBlobReader_Read(stream, bufferSize, outError);

  @override
  ffi.Pointer<CBLReplicator> CBLDart_CBLReplicator_Create(
    ffi.Pointer<CBLDart_ReplicatorConfiguration> config,
    ffi.Pointer<CBLError> errorOut,
  ) => native.CBLDart_CBLReplicator_Create(config, errorOut);

  @override
  void CBLDart_CBLReplicator_Release(ffi.Pointer<CBLReplicator> replicator) =>
      native.CBLDart_CBLReplicator_Release(replicator);
