  ...
  ffi.Pointer<
      ...
      get CBLDart_ListenerPasswordAuthCallbackTrampoline =>
          ffi.Native.addressOf(
              self.CBLDart_ListenerPasswordAuthCallbackTrampoline);
  ffi.Pointer<
...
typedef DartCBLDart_FLSliceResult_ReleaseByBuf = void Function(
    ffi.Pointer<ffi.Void> buf);
typedef NativeCBLDart_KnownSharedKeys_New = ffi.Pointer<imp$2.KnownSharedKeys>
    Function();
typedef DartCBLDart_KnownSharedKeys_New = ffi.Pointer<imp$2.KnownSharedKeys>
    Function();
...
typedef NativeCBLDart_GetLoadedFLValue = ffi.Void Function(
    imp$1.FLValue value, ffi.Pointer<imp$2.CBLDart_LoadedFLValue> out);
...
typedef DartCBLDart_FLDict_GetLoadedFLValue = void Function(imp$1.FLDict dict,
    imp$1.FLString key, ffi.Pointer<imp$2.CBLDart_LoadedFLValue> out);
...
typedef DartCBLDart_FLArrayIterator_Begin
    = ffi.Pointer<imp$2.CBLDart_FLArrayIterator> Function(imp$1.FLArray array,
        ffi.Pointer<imp$2.CBLDart_LoadedFLValue> valueOut, bool deleteOnDone);
...
typedef DartCBLDart_Initialize = int Function(
    ...
    ffi.Pointer<ffi.Void> cblInitContext,
    ffi.Pointer<imp$2.CBLError> errorOut);
typedef NativeCBLDart_AsyncCallback_New = imp$2.CBLDart_AsyncCallback Function(
    ffi.Uint32 id, imp$2.Dart_Port sendPort, ffi.Bool debug);
typedef DartCBLDart_AsyncCallback_New = imp$2.CBLDart_AsyncCallback Function(
    int id, imp$2.DartDart_Port sendPort, bool debug);
...
typedef NativeCBLDart_AsyncCallback_CallForTest = ffi.Void Function(
    imp$2.CBLDart_AsyncCallback callback, ffi.Int64 argument);
typedef DartCBLDart_AsyncCallback_CallForTest = void Function(
    imp$2.CBLDart_AsyncCallback callback, int argument);
typedef NativeCBLDart_Completer_Complete = ffi.Void Function(
    imp$2.CBLDart_Completer completer, ffi.Uint64 result);
typedef DartCBLDart_Completer_Complete = void Function(
    imp$2.CBLDart_Completer completer, int result);
...
typedef DartCBLDart_GetCurrentIsolateId = imp$2.DartCBLDart_IsolateId
    Function();
...
typedef NativeCBLDart_CBLDatabase_Open
    = ffi.Pointer<imp$2.CBLDatabase> Function(
        ...
        ffi.Pointer<CBLDart_CBLDatabaseConfiguration> config,
        ffi.Pointer<imp$2.CBLError> errorOut);
typedef DartCBLDart_CBLDatabase_Open = ffi.Pointer<imp$2.CBLDatabase> Function(
    imp$1.FLString name,
    ffi.Pointer<CBLDart_CBLDatabaseConfiguration> config,
    ffi.Pointer<imp$2.CBLError> errorOut);
...
typedef DartCBLDart_PredictiveModel_Delete = void Function(
    imp$2.CBLDart_PredictiveModel model);
typedef NativeCBLDart_CBLBlobReader_Read = imp$2.FLSliceResult Function(
    ffi.Pointer<imp$2.CBLBlobReadStream> stream,
    ffi.Uint64 bufferSize,
    ffi.Pointer<imp$2.CBLError> outError);
typedef DartCBLDart_CBLBlobReader_Read = imp$2.FLSliceResult Function(
    ffi.Pointer<imp$2.CBLBlobReadStream> stream,
    int bufferSize,
    ffi.Pointer<imp$2.CBLError> outError);
...
typedef NativeCBLDart_ListenerCertAuthCallbackTrampoline = ffi.Bool Function(
    ffi.Pointer<ffi.Void> context, ffi.Pointer<imp$2.CBLCert> cert);
