...
import 'package:cbl_native_assets/src/bindings/cblite.dart' as imp1;
...
@ffi.Native<NativeCBLDart_CBLEndpoint_CreateWithLocalDB>()
external ffi.Pointer<CBLEndpoint> CBLDart_CBLEndpoint_CreateWithLocalDB(
  ffi.Pointer<CBLDatabase> database,
);
...
typedef NativeCBLDart_CBLEndpoint_CreateWithLocalDB = ffi.Pointer<CBLEndpoint>
    Function(ffi.Pointer<CBLDatabase> database);
typedef DartCBLDart_CBLEndpoint_CreateWithLocalDB = ffi.Pointer<CBLEndpoint>
    Function(ffi.Pointer<CBLDatabase> database);
