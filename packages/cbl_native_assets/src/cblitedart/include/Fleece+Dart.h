...
typedef struct KnownSharedKeys KnownSharedKeys;
...
typedef struct CBLDart_FLDictIterator CBLDart_FLDictIterator;
...
typedef struct CBLDart_FLArrayIterator CBLDart_FLArrayIterator;
